package DataLakeAnalyticsAccountManagement::GetStorageContainerAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'DataLakeAnalyticsAccountManagement::GetStorageContainerAccountResult');
