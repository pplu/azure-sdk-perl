package DataLakeAnalyticsAccountManagement::GetStorageAccountAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'DataLakeAnalyticsAccountManagement::GetStorageAccountAccountResult');
