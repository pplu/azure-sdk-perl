package DataLakeStoreFileSystemManagement::ListFileStatusFileSystem;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'DataLakeStoreFileSystemManagement::ListFileStatusFileSystemResult');
