package PowerBIEmbeddedManagement::updateWorkspaceCollections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'PowerBIEmbeddedManagement::updateWorkspaceCollectionsResult');
