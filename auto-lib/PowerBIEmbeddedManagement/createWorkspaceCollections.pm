package PowerBIEmbeddedManagement::createWorkspaceCollections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'PowerBIEmbeddedManagement::createWorkspaceCollectionsResult');
