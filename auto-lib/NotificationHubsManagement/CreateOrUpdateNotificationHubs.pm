package NotificationHubsManagement::CreateOrUpdateNotificationHubs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NotificationHubsManagement::CreateOrUpdateNotificationHubsResult');
