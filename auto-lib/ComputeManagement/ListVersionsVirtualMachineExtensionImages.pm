package ComputeManagement::ListVersionsVirtualMachineExtensionImages;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'ComputeManagement::ListVersionsVirtualMachineExtensionImagesResult');
