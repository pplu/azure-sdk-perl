package ComputeManagement::ListTypesVirtualMachineExtensionImages;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'ComputeManagement::ListTypesVirtualMachineExtensionImagesResult');
