package ComputeManagement::ListAvailableSizesAvailabilitySets;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'ComputeManagement::ListAvailableSizesAvailabilitySetsResult');
