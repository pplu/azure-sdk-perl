package CognitiveServicesManagement::RegenerateKeyCognitiveServicesAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'CognitiveServicesManagement::RegenerateKeyCognitiveServicesAccountsResult');
