package ManagementLock::CreateOrUpdateAtResourceLevelManagementLocks;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'ManagementLock::CreateOrUpdateAtResourceLevelManagementLocksResult');
