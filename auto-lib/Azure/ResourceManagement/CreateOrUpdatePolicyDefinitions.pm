package Azure::ResourceManagement::CreateOrUpdatePolicyDefinitions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ResourceManagement::CreateOrUpdatePolicyDefinitionsResult');
