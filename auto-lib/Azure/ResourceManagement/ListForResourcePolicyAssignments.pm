package Azure::ResourceManagement::ListForResourcePolicyAssignments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ResourceManagement::ListForResourcePolicyAssignmentsResult');
