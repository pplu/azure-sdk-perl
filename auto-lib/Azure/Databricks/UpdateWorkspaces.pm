package Azure::Databricks::UpdateWorkspaces;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Databricks::WorkspaceUpdate',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Databricks::UpdateWorkspacesResult',
    
      202 => undef,
    
      default => 'Azure::Databricks::UpdateWorkspacesResult',
