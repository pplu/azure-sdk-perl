package Azure::IntuneResourceManagement::GetMAMUserFlaggedEnrolledApps;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::IntuneResourceManagement::GetMAMUserFlaggedEnrolledAppsResult',
    
      default => 'Azure::IntuneResourceManagement::GetMAMUserFlaggedEnrolledAppsResult',
