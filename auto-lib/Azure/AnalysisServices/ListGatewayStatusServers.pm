package Azure::AnalysisServices::ListGatewayStatusServers;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AnalysisServices::ListGatewayStatusServersResult',
    
      default => 'Azure::AnalysisServices::ListGatewayStatusServersResult',
