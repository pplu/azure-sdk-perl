package Azure::AnalysisServices::CreateServers;
  use Moose;
  ...
  has 'serverParameters' => (is => 'ro', required => 1, isa => 'Azure::AnalysisServices::AnalysisServicesServer',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AnalysisServices::CreateServersResult',
    
      201 => 'Azure::AnalysisServices::CreateServersResult',
