package Azure::AnalysisServices::UpdateServers;
  use Moose;
  ...
  has 'serverUpdateParameters' => (is => 'ro', required => 1, isa => 'Azure::AnalysisServices::AnalysisServicesServerUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AnalysisServices::UpdateServersResult',
    
      202 => 'Azure::AnalysisServices::UpdateServersResult',
