package Azure::DataLakeStoreFileSystemManagement::ListFileStatusFileSystem;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeStoreFileSystemManagement::ListFileStatusFileSystemResult',
    
      default => 'Azure::DataLakeStoreFileSystemManagement::ListFileStatusFileSystemResult',
