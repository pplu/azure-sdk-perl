package Azure::DataLakeStoreFileSystemManagement::GetContentSummaryFileSystem;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeStoreFileSystemManagement::GetContentSummaryFileSystemResult',
    
      default => 'Azure::DataLakeStoreFileSystemManagement::GetContentSummaryFileSystemResult',
