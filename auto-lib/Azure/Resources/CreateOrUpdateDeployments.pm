package Azure::Resources::CreateOrUpdateDeployments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Resources::CreateOrUpdateDeploymentsResult',
    
      201 => 'Azure::Resources::CreateOrUpdateDeploymentsResult',
