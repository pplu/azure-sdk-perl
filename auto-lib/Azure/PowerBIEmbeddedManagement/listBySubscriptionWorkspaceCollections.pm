package Azure::PowerBIEmbeddedManagement::listBySubscriptionWorkspaceCollections;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBIEmbeddedManagement::listBySubscriptionWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBIEmbeddedManagement::listBySubscriptionWorkspaceCollectionsResult',
