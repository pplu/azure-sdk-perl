package Azure::PowerBIEmbeddedManagement::listByResourceGroupWorkspaceCollections;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBIEmbeddedManagement::listByResourceGroupWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBIEmbeddedManagement::listByResourceGroupWorkspaceCollectionsResult',
