package Azure::PowerBIEmbeddedManagement::checkNameAvailabilityWorkspaceCollections;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBIEmbeddedManagement::checkNameAvailabilityWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBIEmbeddedManagement::checkNameAvailabilityWorkspaceCollectionsResult',
