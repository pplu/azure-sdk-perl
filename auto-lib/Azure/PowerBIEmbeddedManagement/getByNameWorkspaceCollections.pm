package Azure::PowerBIEmbeddedManagement::getByNameWorkspaceCollections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBIEmbeddedManagement::getByNameWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBIEmbeddedManagement::getByNameWorkspaceCollectionsResult',
