package Azure::PowerBIEmbeddedManagement::getAccessKeysWorkspaceCollections;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBIEmbeddedManagement::getAccessKeysWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBIEmbeddedManagement::getAccessKeysWorkspaceCollectionsResult',
