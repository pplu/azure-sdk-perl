package Azure::AppInsightsManagement::UpdateTagsWebTestsResult;
  use Moose;
  ...
  has Configuration => (is => 'ro', isa => 'Azure::AppInsightsManagement::UpdateTagsWebTestsResult_Configuration'  );
