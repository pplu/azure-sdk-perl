package Azure::Scheduler::CreateOrUpdateJobs;
  use Moose;
  ...
  has 'job' => (is => 'ro', required => 1, isa => 'Azure::Scheduler::JobDefinition',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Scheduler::CreateOrUpdateJobsResult',
    
      201 => 'Azure::Scheduler::CreateOrUpdateJobsResult',
