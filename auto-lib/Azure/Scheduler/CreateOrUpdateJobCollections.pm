package Azure::Scheduler::CreateOrUpdateJobCollections;
  use Moose;
  ...
  has 'jobCollection' => (is => 'ro', required => 1, isa => 'Azure::Scheduler::JobCollectionDefinition',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Scheduler::CreateOrUpdateJobCollectionsResult',
    
      201 => 'Azure::Scheduler::CreateOrUpdateJobCollectionsResult',
