package Azure::CognitiveServicesManagement::GetPropertiesAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveServicesManagement::GetPropertiesAccountsResult',
    
      default => 'Azure::CognitiveServicesManagement::GetPropertiesAccountsResult',
