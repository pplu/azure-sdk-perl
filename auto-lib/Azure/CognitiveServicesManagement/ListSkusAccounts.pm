package Azure::CognitiveServicesManagement::ListSkusAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveServicesManagement::ListSkusAccountsResult',
    
      default => 'Azure::CognitiveServicesManagement::ListSkusAccountsResult',
