package Azure::CognitiveServicesManagement::RegenerateKeyAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveServicesManagement::RegenerateKeyAccountsResult',
    
      default => 'Azure::CognitiveServicesManagement::RegenerateKeyAccountsResult',
