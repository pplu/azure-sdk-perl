package Azure::LogicManagement::CreateOrUpdatePartners;
  use Moose;
  ...
  has 'partner' => (is => 'ro', required => 1, isa => 'Azure::LogicManagement::IntegrationAccountPartner',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::LogicManagement::CreateOrUpdatePartnersResult',
    
      201 => 'Azure::LogicManagement::CreateOrUpdatePartnersResult',
