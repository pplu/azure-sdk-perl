package Azure::LogicManagement::GenerateUpgradedDefinitionWorkflows;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::LogicManagement::GenerateUpgradedDefinitionParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::LogicManagement::GenerateUpgradedDefinitionWorkflowsResult',
