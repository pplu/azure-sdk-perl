package Azure::LogicManagement::CreateOrUpdateMaps;
  use Moose;
  ...
  has 'map' => (is => 'ro', required => 1, isa => 'Azure::LogicManagement::IntegrationAccountMap',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::LogicManagement::CreateOrUpdateMapsResult',
    
      201 => 'Azure::LogicManagement::CreateOrUpdateMapsResult',
