package Azure::LogicManagement::CreateOrUpdateIntegrationAccountAgreements;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::LogicManagement::CreateOrUpdateIntegrationAccountAgreementsResult');
