package Azure::LogicManagement::GetIntegrationAccountAgreements;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::LogicManagement::GetIntegrationAccountAgreementsResult');
