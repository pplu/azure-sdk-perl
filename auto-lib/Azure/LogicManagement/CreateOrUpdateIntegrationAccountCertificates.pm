package Azure::LogicManagement::CreateOrUpdateIntegrationAccountCertificates;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'LogicManagement::CreateOrUpdateIntegrationAccountCertificatesResult');
