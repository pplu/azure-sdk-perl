package Azure::LogicManagement::CreateOrUpdateSchemasResult;
  ...
  has content => (is => 'ro', isa => 'Azure::LogicManagement::CreateOrUpdateSchemasResult_content'  );
  has contentLink => (is => 'ro', isa => 'Azure::LogicManagement::ContentLink'  );
  has contentType => (is => 'ro', isa => 'Str'  );
  has createdTime => (is => 'ro', isa => 'Str'  );
  has documentName => (is => 'ro', isa => 'Str'  );
  has fileName => (is => 'ro', isa => 'Str'  );
  has metadata => (is => 'ro', isa => 'Azure::LogicManagement::CreateOrUpdateSchemasResult_metadata'  );
