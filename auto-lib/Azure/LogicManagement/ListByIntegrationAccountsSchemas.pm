package Azure::LogicManagement::ListByIntegrationAccountsSchemas;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::LogicManagement::ListByIntegrationAccountsSchemasResult');
