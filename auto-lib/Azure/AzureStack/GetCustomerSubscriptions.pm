package Azure::AzureStack::GetCustomerSubscriptions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AzureStack::GetCustomerSubscriptionsResult',
    
      default => 'Azure::AzureStack::GetCustomerSubscriptionsResult',
