package Azure::ComputeManagement::UpdateVirtualMachineScaleSets;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ComputeManagement::VirtualMachineScaleSetUpdate',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ComputeManagement::UpdateVirtualMachineScaleSetsResult');
