package Azure::ComputeManagement::ListVirtualMachineRunCommands;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ComputeManagement::ListVirtualMachineRunCommandsResult');
