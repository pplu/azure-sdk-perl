package Azure::ComputeManagement::GetVirtualMachineScaleSetExtensions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ComputeManagement::GetVirtualMachineScaleSetExtensionsResult');
