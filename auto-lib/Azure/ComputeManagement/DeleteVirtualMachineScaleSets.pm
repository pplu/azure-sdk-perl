package Azure::ComputeManagement::DeleteVirtualMachineScaleSets;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ComputeManagement::DeleteVirtualMachineScaleSetsResult');
