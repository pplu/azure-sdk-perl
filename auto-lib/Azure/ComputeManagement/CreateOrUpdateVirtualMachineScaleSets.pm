package Azure::ComputeManagement::CreateOrUpdateVirtualMachineScaleSets;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ComputeManagement::CreateOrUpdateVirtualMachineScaleSetsResult',
    
      201 => 'Azure::ComputeManagement::CreateOrUpdateVirtualMachineScaleSetsResult',
