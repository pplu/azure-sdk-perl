package Azure::ComputeManagement::ListAvailableSizesVirtualMachines;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'ComputeManagement::ListAvailableSizesVirtualMachinesResult');
