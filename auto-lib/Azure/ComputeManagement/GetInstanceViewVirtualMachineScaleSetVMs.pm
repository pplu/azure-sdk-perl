package Azure::ComputeManagement::GetInstanceViewVirtualMachineScaleSetVMs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ComputeManagement::GetInstanceViewVirtualMachineScaleSetVMsResult');
