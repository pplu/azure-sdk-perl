package Azure::ComputeManagement::CreateOrUpdateSnapshots;
  use Moose;
  ...
  has 'snapshot' => (is => 'ro', required => 1, isa => 'Azure::ComputeManagement::Snapshot',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ComputeManagement::CreateOrUpdateSnapshotsResult',
    
      202 => 'Azure::ComputeManagement::CreateOrUpdateSnapshotsResult',
