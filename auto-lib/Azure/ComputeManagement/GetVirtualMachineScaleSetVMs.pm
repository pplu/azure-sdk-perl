package Azure::ComputeManagement::GetVirtualMachineScaleSetVMs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ComputeManagement::GetVirtualMachineScaleSetVMsResult');
