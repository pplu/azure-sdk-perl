package Azure::ComputeManagement::ListVirtualMachineScaleSetVMs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ComputeManagement::ListVirtualMachineScaleSetVMsResult');
