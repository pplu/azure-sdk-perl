package Azure::Application::CreateOrUpdateApplications;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Application::CreateOrUpdateApplicationsResult',
    
      201 => 'Azure::Application::CreateOrUpdateApplicationsResult',
    
      default => 'Azure::Application::CreateOrUpdateApplicationsResult',
