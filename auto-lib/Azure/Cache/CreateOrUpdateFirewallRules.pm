package Azure::Cache::CreateOrUpdateFirewallRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Cache::RedisFirewallRuleCreateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Cache::CreateOrUpdateFirewallRulesResult',
    
      201 => 'Azure::Cache::CreateOrUpdateFirewallRulesResult',
