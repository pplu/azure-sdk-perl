package Azure::Cache::CreateLinkedServer;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Cache::RedisLinkedServerCreateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Cache::CreateLinkedServerResult',
    
      201 => 'Azure::Cache::CreateLinkedServerResult',
