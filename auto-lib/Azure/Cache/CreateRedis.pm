package Azure::Cache::CreateRedis;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Cache::RedisCreateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Cache::CreateRedisResult',
    
      201 => 'Azure::Cache::CreateRedisResult',
