package Azure::Cache::CreateOrUpdatePatchSchedules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Cache::RedisPatchSchedule',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Cache::CreateOrUpdatePatchSchedulesResult',
    
      201 => 'Azure::Cache::CreateOrUpdatePatchSchedulesResult',
