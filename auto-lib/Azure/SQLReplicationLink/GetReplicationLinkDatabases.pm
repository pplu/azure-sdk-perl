package Azure::SQLReplicationLink::GetReplicationLinkDatabases;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SQLReplicationLink::GetReplicationLinkDatabasesResult');
