package Azure::CognitiveCustomWebSearch::SearchCustomInstance;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveCustomWebSearch::SearchCustomInstanceResult',
    
      default => 'Azure::CognitiveCustomWebSearch::SearchCustomInstanceResult',
