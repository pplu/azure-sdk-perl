package Azure::CognitiveCustomWebSearch::WebPage;
  use Moose;

  has 'dateLastCrawled' => (is => 'ro', isa => 'Str'  );
  has 'deepLinks' => (is => 'ro', isa => 'ArrayRef[Azure::CognitiveCustomWebSearch::WebPage]'  );
  has 'displayUrl' => (is => 'ro', isa => 'Str'  );
  has 'searchTags' => (is => 'ro', isa => 'ArrayRef[Azure::CognitiveCustomWebSearch::WebMetaTag]'  );
