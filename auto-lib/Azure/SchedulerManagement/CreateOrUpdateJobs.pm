package Azure::SchedulerManagement::CreateOrUpdateJobs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::SchedulerManagement::CreateOrUpdateJobsResult',
    
      201 => 'Azure::SchedulerManagement::CreateOrUpdateJobsResult',
