package Azure::Web::GetWorkerPoolAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Web::GetWorkerPoolAppServiceEnvironmentsResult',
    
      default => 'Azure::Web::GetWorkerPoolAppServiceEnvironmentsResult',
