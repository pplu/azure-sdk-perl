package Azure::Web::ResumeAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Web::ResumeAppServiceEnvironmentsResult',
    
      202 => 'Azure::Web::ResumeAppServiceEnvironmentsResult',
    
      default => 'Azure::Web::ResumeAppServiceEnvironmentsResult',
