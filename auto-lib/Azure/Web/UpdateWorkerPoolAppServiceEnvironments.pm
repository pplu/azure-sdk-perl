package Azure::Web::UpdateWorkerPoolAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Web::UpdateWorkerPoolAppServiceEnvironmentsResult',
    
      202 => 'Azure::Web::UpdateWorkerPoolAppServiceEnvironmentsResult',
