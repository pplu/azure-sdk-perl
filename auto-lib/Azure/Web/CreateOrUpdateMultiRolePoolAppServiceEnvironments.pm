package Azure::Web::CreateOrUpdateMultiRolePoolAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Web::CreateOrUpdateMultiRolePoolAppServiceEnvironmentsResult',
    
      202 => 'Azure::Web::CreateOrUpdateMultiRolePoolAppServiceEnvironmentsResult',
