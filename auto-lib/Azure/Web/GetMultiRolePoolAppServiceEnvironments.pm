package Azure::Web::GetMultiRolePoolAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Web::GetMultiRolePoolAppServiceEnvironmentsResult',
    
      default => 'Azure::Web::GetMultiRolePoolAppServiceEnvironmentsResult',
