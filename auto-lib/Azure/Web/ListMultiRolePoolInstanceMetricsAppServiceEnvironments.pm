package Azure::Web::ListMultiRolePoolInstanceMetricsAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Web::ListMultiRolePoolInstanceMetricsAppServiceEnvironmentsResult',
    
      default => 'Azure::Web::ListMultiRolePoolInstanceMetricsAppServiceEnvironmentsResult',
