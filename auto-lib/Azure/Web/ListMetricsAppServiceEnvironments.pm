package Azure::Web::ListMetricsAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Web::ListMetricsAppServiceEnvironmentsResult',
    
      default => 'Azure::Web::ListMetricsAppServiceEnvironmentsResult',
