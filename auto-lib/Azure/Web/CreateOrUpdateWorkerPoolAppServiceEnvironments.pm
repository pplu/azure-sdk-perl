package Azure::Web::CreateOrUpdateWorkerPoolAppServiceEnvironments;
  use Moose;
  ...
  has 'workerPoolEnvelope' => (is => 'ro', required => 1, isa => 'Azure::Web::WorkerPoolResource',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Web::CreateOrUpdateWorkerPoolAppServiceEnvironmentsResult',
    
      202 => 'Azure::Web::CreateOrUpdateWorkerPoolAppServiceEnvironmentsResult',
