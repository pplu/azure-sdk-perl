package Azure::PowerBI::updateWorkspaceCollections;
  use Moose;
  ...
  has 'body' => (is => 'ro', required => 1, isa => 'Azure::PowerBI::UpdateWorkspaceCollectionRequest',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBI::updateWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBI::updateWorkspaceCollectionsResult',
