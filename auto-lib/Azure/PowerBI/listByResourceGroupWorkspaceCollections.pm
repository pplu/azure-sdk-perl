package Azure::PowerBI::listByResourceGroupWorkspaceCollections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBI::listByResourceGroupWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBI::listByResourceGroupWorkspaceCollectionsResult',
