package Azure::PowerBI::createWorkspaceCollections;
  use Moose;
  ...
  has 'body' => (is => 'ro', required => 1, isa => 'Azure::PowerBI::CreateWorkspaceCollectionRequest',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBI::createWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBI::createWorkspaceCollectionsResult',
