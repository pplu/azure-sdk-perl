package Azure::PowerBI::getByNameWorkspaceCollections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBI::getByNameWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBI::getByNameWorkspaceCollectionsResult',
