package Azure::PowerBI::getAccessKeysWorkspaceCollections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBI::getAccessKeysWorkspaceCollectionsResult',
    
      default => 'Azure::PowerBI::getAccessKeysWorkspaceCollectionsResult',
