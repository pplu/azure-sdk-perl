package Azure::CognitiveEntitySearch::Restaurant;
  use Moose;

  has 'acceptsReservations' => (is => 'ro', isa => 'Bool'  );
  has 'menuUrl' => (is => 'ro', isa => 'Str'  );
  has 'reservationUrl' => (is => 'ro', isa => 'Str'  );
  has 'servesCuisine' => (is => 'ro', isa => 'ArrayRef[Str]'  );
