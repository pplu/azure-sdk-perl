package Azure::CosmosDB::CreateOrUpdateDatabaseAccounts;
  use Moose;
  ...
  has 'createUpdateParameters' => (is => 'ro', required => 1, isa => 'Azure::CosmosDB::DatabaseAccountCreateUpdateParameters',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::CosmosDB::CreateOrUpdateDatabaseAccountsResult');
