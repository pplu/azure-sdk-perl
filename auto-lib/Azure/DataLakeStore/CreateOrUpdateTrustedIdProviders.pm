package Azure::DataLakeStore::CreateOrUpdateTrustedIdProviders;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DataLakeStore::CreateOrUpdateTrustedIdProviderParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeStore::CreateOrUpdateTrustedIdProvidersResult',
