package Azure::DataLakeStore::UpdateFirewallRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::DataLakeStore::UpdateFirewallRuleParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeStore::UpdateFirewallRulesResult',
