package Azure::DataLakeStore::UpdateTrustedIdProviders;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::DataLakeStore::UpdateTrustedIdProviderParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeStore::UpdateTrustedIdProvidersResult',
