package Azure::Advisor::CreateSuppressions;
  use Moose;
  ...
  has 'suppressionContract' => (is => 'ro', required => 1, isa => 'Azure::Advisor::SuppressionContract',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Advisor::CreateSuppressionsResult',
