package Azure::KeyVault::CreateOrUpdateVaults;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::KeyVault::VaultCreateOrUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVault::CreateOrUpdateVaultsResult',
    
      201 => 'Azure::KeyVault::CreateOrUpdateVaultsResult',
