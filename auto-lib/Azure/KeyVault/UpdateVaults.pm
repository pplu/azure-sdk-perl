package Azure::KeyVault::UpdateVaults;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::KeyVault::VaultPatchParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVault::UpdateVaultsResult',
    
      201 => 'Azure::KeyVault::UpdateVaultsResult',
