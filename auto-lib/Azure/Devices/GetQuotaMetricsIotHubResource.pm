package Azure::Devices::GetQuotaMetricsIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Devices::GetQuotaMetricsIotHubResourceResult',
    
      default => 'Azure::Devices::GetQuotaMetricsIotHubResourceResult',
