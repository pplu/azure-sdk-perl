package Azure::Devices::VerifyCertificateDpsCertificate;
  use Moose;
  ...
  has 'request' => (is => 'ro', required => 1, isa => 'Azure::Devices::VerificationCodeRequest',
  ...
  class_has _api_uri => (is => 'ro', default => '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/certificates/{certificateName}/verify');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::Devices::VerifyCertificateDpsCertificateResult',
    
      default => 'Azure::Devices::VerifyCertificateDpsCertificateResult',
