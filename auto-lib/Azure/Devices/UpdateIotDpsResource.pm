package Azure::Devices::UpdateIotDpsResource;
  use Moose;
  use MooseX::ClassAttribute;

  has 'ProvisioningServiceTags' => (is => 'ro', required => 1, isa => 'Azure::Devices::TagsResource',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Devices::UpdateIotDpsResourceResult',
