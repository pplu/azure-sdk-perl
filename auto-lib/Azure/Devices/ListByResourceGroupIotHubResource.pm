package Azure::Devices::ListByResourceGroupIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Devices::ListByResourceGroupIotHubResourceResult',
    
      default => 'Azure::Devices::ListByResourceGroupIotHubResourceResult',
