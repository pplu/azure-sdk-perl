package Azure::Devices::GetKeysForKeyNameIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Devices::GetKeysForKeyNameIotHubResourceResult',
    
      default => 'Azure::Devices::GetKeysForKeyNameIotHubResourceResult',
