package Azure::Devices::GetValidSkusIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Devices::GetValidSkusIotHubResourceResult',
    
      default => 'Azure::Devices::GetValidSkusIotHubResourceResult',
