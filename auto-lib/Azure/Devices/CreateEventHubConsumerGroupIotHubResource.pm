package Azure::Devices::CreateEventHubConsumerGroupIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Devices::CreateEventHubConsumerGroupIotHubResourceResult',
    
      default => 'Azure::Devices::CreateEventHubConsumerGroupIotHubResourceResult',
