package Azure::CognitiveServices::ListKeysAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveServices::ListKeysAccountsResult',
    
      default => 'Azure::CognitiveServices::ListKeysAccountsResult',
