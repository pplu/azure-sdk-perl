package Azure::CognitiveServices::GetPropertiesAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveServices::GetPropertiesAccountsResult',
    
      default => 'Azure::CognitiveServices::GetPropertiesAccountsResult',
