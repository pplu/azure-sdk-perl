package Azure::CognitiveServices::ListByResourceGroupAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveServices::ListByResourceGroupAccountsResult',
    
      default => 'Azure::CognitiveServices::ListByResourceGroupAccountsResult',
