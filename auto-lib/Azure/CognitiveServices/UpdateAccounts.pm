package Azure::CognitiveServices::UpdateAccounts;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::CognitiveServices::CognitiveServicesAccountUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveServices::UpdateAccountsResult',
    
      default => 'Azure::CognitiveServices::UpdateAccountsResult',
