package Azure::CognitiveServices::ListSkusAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveServices::ListSkusAccountsResult',
    
      default => 'Azure::CognitiveServices::ListSkusAccountsResult',
