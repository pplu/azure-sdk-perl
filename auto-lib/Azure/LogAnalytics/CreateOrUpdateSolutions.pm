package Azure::LogAnalytics::CreateOrUpdateSolutions;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::LogAnalytics::Solution',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::LogAnalytics::CreateOrUpdateSolutionsResult');
