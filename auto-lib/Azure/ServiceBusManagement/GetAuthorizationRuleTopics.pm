package Azure::ServiceBusManagement::GetAuthorizationRuleTopics;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::GetAuthorizationRuleTopicsResult',
    
      default => 'Azure::ServiceBusManagement::GetAuthorizationRuleTopicsResult',
