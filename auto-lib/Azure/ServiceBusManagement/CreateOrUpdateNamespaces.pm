package Azure::ServiceBusManagement::CreateOrUpdateNamespaces;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ServiceBusManagement::SBNamespace',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::CreateOrUpdateNamespacesResult',
    
      201 => 'Azure::ServiceBusManagement::CreateOrUpdateNamespacesResult',
    
      202 => undef,
    
      default => 'Azure::ServiceBusManagement::CreateOrUpdateNamespacesResult',
