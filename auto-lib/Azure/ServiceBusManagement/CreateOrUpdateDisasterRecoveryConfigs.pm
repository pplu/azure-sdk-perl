package Azure::ServiceBusManagement::CreateOrUpdateDisasterRecoveryConfigs;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::CreateOrUpdateDisasterRecoveryConfigsResult',
    
      201 => undef,
    
      default => 'Azure::ServiceBusManagement::CreateOrUpdateDisasterRecoveryConfigsResult',
