package Azure::ServiceBusManagement::GetNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::GetNamespacesResult',
    
      default => 'Azure::ServiceBusManagement::GetNamespacesResult',
