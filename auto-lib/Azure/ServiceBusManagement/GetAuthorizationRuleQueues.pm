package Azure::ServiceBusManagement::GetAuthorizationRuleQueues;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::GetAuthorizationRuleQueuesResult',
    
      default => 'Azure::ServiceBusManagement::GetAuthorizationRuleQueuesResult',
