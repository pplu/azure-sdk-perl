package Azure::ServiceBusManagement::CreateOrUpdateRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ServiceBusManagement::Rule',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::CreateOrUpdateRulesResult',
    
      default => 'Azure::ServiceBusManagement::CreateOrUpdateRulesResult',
