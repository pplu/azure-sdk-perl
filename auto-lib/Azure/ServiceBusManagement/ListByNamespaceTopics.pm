package Azure::ServiceBusManagement::ListByNamespaceTopics;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::ListByNamespaceTopicsResult',
    
      default => 'Azure::ServiceBusManagement::ListByNamespaceTopicsResult',
