package Azure::ServiceBusManagement::CreateOrUpdateAuthorizationRuleTopics;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::CreateOrUpdateAuthorizationRuleTopicsResult',
    
      default => 'Azure::ServiceBusManagement::CreateOrUpdateAuthorizationRuleTopicsResult',
