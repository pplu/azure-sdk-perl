package Azure::ServiceBusManagement::ListKeysNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::ListKeysNamespacesResult',
    
      default => 'Azure::ServiceBusManagement::ListKeysNamespacesResult',
