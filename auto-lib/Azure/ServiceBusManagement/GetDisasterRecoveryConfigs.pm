package Azure::ServiceBusManagement::GetDisasterRecoveryConfigs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBusManagement::GetDisasterRecoveryConfigsResult',
    
      default => 'Azure::ServiceBusManagement::GetDisasterRecoveryConfigsResult',
