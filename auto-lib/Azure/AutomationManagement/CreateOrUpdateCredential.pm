package Azure::AutomationManagement::CreateOrUpdateCredential;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::AutomationManagement::CredentialCreateOrUpdateParameters',
