package Azure::AutomationManagement::UpdateSchedule;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::AutomationManagement::ScheduleUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AutomationManagement::UpdateScheduleResult',
    
      default => 'Azure::AutomationManagement::UpdateScheduleResult',
