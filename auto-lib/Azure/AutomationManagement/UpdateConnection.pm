package Azure::AutomationManagement::UpdateConnection;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::AutomationManagement::ConnectionUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AutomationManagement::UpdateConnectionResult',
    
      default => 'Azure::AutomationManagement::UpdateConnectionResult',
