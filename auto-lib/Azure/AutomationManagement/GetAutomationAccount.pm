package Azure::AutomationManagement::GetAutomationAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AutomationManagement::GetAutomationAccountResult',
    
      default => 'Azure::AutomationManagement::GetAutomationAccountResult',
