package Azure::AutomationManagement::RegenerateKeyAgentRegistrationInformation;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AutomationManagement::RegenerateKeyAgentRegistrationInformationResult',
    
      default => 'Azure::AutomationManagement::RegenerateKeyAgentRegistrationInformationResult',
