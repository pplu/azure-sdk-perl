package Azure::AutomationManagement::UpdateDscNode;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::AutomationManagement::DscNodeUpdateParameters',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AutomationManagement::UpdateDscNodeResult');
