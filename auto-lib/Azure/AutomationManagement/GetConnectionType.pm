package Azure::AutomationManagement::GetConnectionType;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AutomationManagement::GetConnectionTypeResult',
    
      default => 'Azure::AutomationManagement::GetConnectionTypeResult',
