package Azure::AutomationManagement::UpdateWebhook;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::AutomationManagement::WebhookUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AutomationManagement::UpdateWebhookResult',
    
      default => 'Azure::AutomationManagement::UpdateWebhookResult',
