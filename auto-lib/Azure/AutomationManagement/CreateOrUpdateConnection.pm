package Azure::AutomationManagement::CreateOrUpdateConnection;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::AutomationManagement::ConnectionCreateOrUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AutomationManagement::CreateOrUpdateConnectionResult',
    
      201 => 'Azure::AutomationManagement::CreateOrUpdateConnectionResult',
    
      default => 'Azure::AutomationManagement::CreateOrUpdateConnectionResult',
