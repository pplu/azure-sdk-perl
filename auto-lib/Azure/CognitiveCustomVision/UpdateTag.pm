package Azure::CognitiveCustomVision::UpdateTag;
  use Moose;
  ...
  has 'updatedTag' => (is => 'ro', required => 1, isa => 'Azure::CognitiveCustomVision::Tag',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveCustomVision::UpdateTagResult',
