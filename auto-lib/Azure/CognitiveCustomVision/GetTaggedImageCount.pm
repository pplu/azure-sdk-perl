package Azure::CognitiveCustomVision::GetTaggedImageCount;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/projects/{projectId}/images/tagged/count');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::CognitiveCustomVision::GetTaggedImageCountResult',
