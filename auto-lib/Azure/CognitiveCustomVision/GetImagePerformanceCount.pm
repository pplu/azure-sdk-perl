package Azure::CognitiveCustomVision::GetImagePerformanceCount;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/projects/{projectId}/iterations/{iterationId}/performance/images/count');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::CognitiveCustomVision::GetImagePerformanceCountResult',
