package Azure::CognitiveCustomVision::CreateImageRegions;
  use Moose;
  ...
  has 'batch' => (is => 'ro', required => 1, isa => 'Azure::CognitiveCustomVision::ImageRegionCreateBatch',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CognitiveCustomVision::CreateImageRegionsResult',
