package Azure::iotHub::CreateEventHubConsumerGroupIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::iotHub::CreateEventHubConsumerGroupIotHubResourceResult',
    
      default => 'Azure::iotHub::CreateEventHubConsumerGroupIotHubResourceResult',
