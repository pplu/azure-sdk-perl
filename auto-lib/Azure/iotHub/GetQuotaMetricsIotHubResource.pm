package Azure::iotHub::GetQuotaMetricsIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::iotHub::GetQuotaMetricsIotHubResourceResult',
    
      default => 'Azure::iotHub::GetQuotaMetricsIotHubResourceResult',
