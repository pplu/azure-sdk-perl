package Azure::iotHub::GetEventHubConsumerGroupIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::iotHub::GetEventHubConsumerGroupIotHubResourceResult',
    
      default => 'Azure::iotHub::GetEventHubConsumerGroupIotHubResourceResult',
