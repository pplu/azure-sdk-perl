package Azure::iotHub::ImportDevicesIotHubResource;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::iotHub::ImportDevicesIotHubResourceResult',
    
      default => 'Azure::iotHub::ImportDevicesIotHubResourceResult',
