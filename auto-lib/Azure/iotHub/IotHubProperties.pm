package Azure::iotHub::IotHubProperties;
  ...
  has 'eventHubEndpoints' => (is => 'ro', isa => 'HashRef[Azure::iotHub::EventHubProperties]'  );
  has 'features' => (is => 'ro', isa => 'Str'  );
  has 'hostName' => (is => 'ro', isa => 'Str'  );
  has 'ipFilterRules' => (is => 'ro', isa => 'ArrayRef[Azure::iotHub::IpFilterRule]'  );
  has 'messagingEndpoints' => (is => 'ro', isa => 'HashRef[Azure::iotHub::MessagingEndpointProperties]'  );
  ...
  has 'storageEndpoints' => (is => 'ro', isa => 'HashRef[Azure::iotHub::StorageEndpointProperties]'  );
1;
