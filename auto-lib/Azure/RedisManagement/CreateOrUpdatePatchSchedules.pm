package Azure::RedisManagement::CreateOrUpdatePatchSchedules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RedisManagement::CreateOrUpdatePatchSchedulesResult',
    
      201 => 'Azure::RedisManagement::CreateOrUpdatePatchSchedulesResult',
