package Azure::Logic::CreateOrUpdateSchemas;
  use Moose;
  ...
  has 'schema' => (is => 'ro', required => 1, isa => 'Azure::Logic::IntegrationAccountSchema',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Logic::CreateOrUpdateSchemasResult',
    
      201 => 'Azure::Logic::CreateOrUpdateSchemasResult',
