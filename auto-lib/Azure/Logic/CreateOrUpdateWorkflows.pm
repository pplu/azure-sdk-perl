package Azure::Logic::CreateOrUpdateWorkflows;
  use Moose;
  ...
  has 'workflow' => (is => 'ro', required => 1, isa => 'Azure::Logic::Workflow',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Logic::CreateOrUpdateWorkflowsResult',
    
      201 => 'Azure::Logic::CreateOrUpdateWorkflowsResult',
