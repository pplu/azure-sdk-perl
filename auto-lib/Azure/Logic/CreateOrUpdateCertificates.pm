package Azure::Logic::CreateOrUpdateCertificates;
  use Moose;
  ...
  has 'certificate' => (is => 'ro', required => 1, isa => 'Azure::Logic::IntegrationAccountCertificate',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Logic::CreateOrUpdateCertificatesResult',
    
      201 => 'Azure::Logic::CreateOrUpdateCertificatesResult',
