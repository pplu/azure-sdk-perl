package Azure::Logic::CreateOrUpdatePartners;
  use Moose;
  ...
  has 'partner' => (is => 'ro', required => 1, isa => 'Azure::Logic::IntegrationAccountPartner',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Logic::CreateOrUpdatePartnersResult',
    
      201 => 'Azure::Logic::CreateOrUpdatePartnersResult',
