package Azure::Logic::CreateOrUpdateIntegrationAccounts;
  use Moose;
  ...
  has 'integrationAccount' => (is => 'ro', required => 1, isa => 'Azure::Logic::IntegrationAccount',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Logic::CreateOrUpdateIntegrationAccountsResult',
    
      201 => 'Azure::Logic::CreateOrUpdateIntegrationAccountsResult',
