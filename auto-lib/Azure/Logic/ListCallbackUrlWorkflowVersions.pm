package Azure::Logic::ListCallbackUrlWorkflowVersions;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::Logic::GetCallbackUrlParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Logic::ListCallbackUrlWorkflowVersionsResult',
