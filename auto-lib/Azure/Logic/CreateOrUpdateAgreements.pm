package Azure::Logic::CreateOrUpdateAgreements;
  use Moose;
  use MooseX::ClassAttribute;

  has 'agreement' => (is => 'ro', required => 1, isa => 'Azure::Logic::IntegrationAccountAgreement',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Logic::CreateOrUpdateAgreementsResult',
    
      201 => 'Azure::Logic::CreateOrUpdateAgreementsResult',
