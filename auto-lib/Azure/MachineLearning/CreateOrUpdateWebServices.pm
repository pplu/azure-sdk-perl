package Azure::MachineLearning::CreateOrUpdateWebServices;
  use Moose;
  ...
  has 'createOrUpdatePayload' => (is => 'ro', required => 1, isa => 'Azure::MachineLearning::WebService',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::MachineLearning::CreateOrUpdateWebServicesResult',
    
      201 => 'Azure::MachineLearning::CreateOrUpdateWebServicesResult',
