package Azure::ContainerInstance::DeleteContainerGroupsResult;
  use Moose;
  ...
  has instanceView => (is => 'ro', isa => 'Azure::ContainerInstance::DeleteContainerGroupsResult_instanceView'  );
