package Azure::ContainerInstance::UpdateContainerGroupsResult;
  use Moose;
  ...
  has instanceView => (is => 'ro', isa => 'Azure::ContainerInstance::UpdateContainerGroupsResult_instanceView'  );
