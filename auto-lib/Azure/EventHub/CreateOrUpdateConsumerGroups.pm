package Azure::EventHub::CreateOrUpdateConsumerGroups;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::EventHub::ConsumerGroup',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::CreateOrUpdateConsumerGroupsResult',
    
      default => 'Azure::EventHub::CreateOrUpdateConsumerGroupsResult',
