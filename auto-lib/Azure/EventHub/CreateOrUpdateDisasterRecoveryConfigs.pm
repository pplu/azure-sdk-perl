package Azure::EventHub::CreateOrUpdateDisasterRecoveryConfigs;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::EventHub::ArmDisasterRecovery',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::CreateOrUpdateDisasterRecoveryConfigsResult',
    
      201 => undef,
    
      default => 'Azure::EventHub::CreateOrUpdateDisasterRecoveryConfigsResult',
