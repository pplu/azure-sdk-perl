package Azure::EventHub::ListByResourceGroupNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::ListByResourceGroupNamespacesResult',
    
      default => 'Azure::EventHub::ListByResourceGroupNamespacesResult',
