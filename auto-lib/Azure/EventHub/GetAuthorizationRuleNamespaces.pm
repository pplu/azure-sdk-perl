package Azure::EventHub::GetAuthorizationRuleNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::GetAuthorizationRuleNamespacesResult',
    
      default => 'Azure::EventHub::GetAuthorizationRuleNamespacesResult',
