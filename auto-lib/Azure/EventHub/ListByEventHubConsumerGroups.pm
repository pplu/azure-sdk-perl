package Azure::EventHub::ListByEventHubConsumerGroups;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::ListByEventHubConsumerGroupsResult',
    
      default => 'Azure::EventHub::ListByEventHubConsumerGroupsResult',
