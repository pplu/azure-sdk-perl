package Azure::EventHub::GetDisasterRecoveryConfigs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::GetDisasterRecoveryConfigsResult',
    
      default => 'Azure::EventHub::GetDisasterRecoveryConfigsResult',
