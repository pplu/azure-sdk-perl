package Azure::EventHub::CreateOrUpdateEventHubs;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::EventHub::Eventhub',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::CreateOrUpdateEventHubsResult',
    
      default => 'Azure::EventHub::CreateOrUpdateEventHubsResult',
