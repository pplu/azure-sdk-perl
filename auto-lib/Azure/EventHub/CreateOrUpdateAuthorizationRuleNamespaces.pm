package Azure::EventHub::CreateOrUpdateAuthorizationRuleNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::CreateOrUpdateAuthorizationRuleNamespacesResult',
    
      default => 'Azure::EventHub::CreateOrUpdateAuthorizationRuleNamespacesResult',
