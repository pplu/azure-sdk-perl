package Azure::EventHub::ListAuthorizationRulesNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::ListAuthorizationRulesNamespacesResult',
    
      default => 'Azure::EventHub::ListAuthorizationRulesNamespacesResult',
