package Azure::EventHub::GetNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHub::GetNamespacesResult',
    
      201 => 'Azure::EventHub::GetNamespacesResult',
    
      default => 'Azure::EventHub::GetNamespacesResult',
