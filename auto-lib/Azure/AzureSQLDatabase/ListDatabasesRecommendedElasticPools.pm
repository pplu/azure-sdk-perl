package Azure::AzureSQLDatabase::ListDatabasesRecommendedElasticPools;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AzureSQLDatabase::ListDatabasesRecommendedElasticPoolsResult');
