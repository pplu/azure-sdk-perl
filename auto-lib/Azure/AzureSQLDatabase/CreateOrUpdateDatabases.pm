package Azure::AzureSQLDatabase::CreateOrUpdateDatabases;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::AzureSQLDatabase::Database',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AzureSQLDatabase::CreateOrUpdateDatabasesResult');
