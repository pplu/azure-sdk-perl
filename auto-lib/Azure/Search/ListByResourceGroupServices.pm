package Azure::Search::ListByResourceGroupServices;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Search::ListByResourceGroupServicesResult',
    
      default => 'Azure::Search::ListByResourceGroupServicesResult',
