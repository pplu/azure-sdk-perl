package Azure::StreamAnalyticsManagement::CreateOrReplaceFunctions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StreamAnalyticsManagement::CreateOrReplaceFunctionsResult');
