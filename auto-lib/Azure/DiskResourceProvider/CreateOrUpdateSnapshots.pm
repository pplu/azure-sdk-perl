package Azure::DiskResourceProvider::CreateOrUpdateSnapshots;
  use Moose;
  ...
  has 'snapshot' => (is => 'ro', required => 1, isa => 'Azure::DiskResourceProvider::Snapshot',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DiskResourceProvider::CreateOrUpdateSnapshotsResult');
