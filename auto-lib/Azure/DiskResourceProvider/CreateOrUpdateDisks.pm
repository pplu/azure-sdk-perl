package Azure::DiskResourceProvider::CreateOrUpdateDisks;
  use Moose;
  ...
  has 'disk' => (is => 'ro', required => 1, isa => 'Azure::DiskResourceProvider::Disk',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DiskResourceProvider::CreateOrUpdateDisksResult');
