package Azure::CognitiveFace::CreateFaceList;
  use Moose;
  ...
  has 'body' => (is => 'ro', required => 1, isa => 'Azure::CognitiveFace::CreateFaceListRequest',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::CognitiveFace::CreateFaceListResult',
