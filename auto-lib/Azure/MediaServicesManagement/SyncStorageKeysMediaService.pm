package Azure::MediaServicesManagement::SyncStorageKeysMediaService;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::MediaServicesManagement::SyncStorageKeysInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::MediaServicesManagement::SyncStorageKeysMediaServiceResult',
