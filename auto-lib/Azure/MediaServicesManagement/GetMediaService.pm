package Azure::MediaServicesManagement::GetMediaService;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::MediaServicesManagement::GetMediaServiceResult',
    
      default => 'Azure::MediaServicesManagement::GetMediaServiceResult',
