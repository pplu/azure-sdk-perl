package Azure::MediaServicesManagement::CheckNameAvailabilityMediaService;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::MediaServicesManagement::CheckNameAvailabilityMediaServiceResult',
    
      default => 'Azure::MediaServicesManagement::CheckNameAvailabilityMediaServiceResult',
