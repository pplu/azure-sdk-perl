package Azure::MediaServicesManagement::ListKeysMediaService;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::MediaServicesManagement::ListKeysMediaServiceResult',
    
      default => 'Azure::MediaServicesManagement::ListKeysMediaServiceResult',
