package Azure::ContainerRegistryManagement::GetPropertiesRegistries;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ContainerRegistryManagement::GetPropertiesRegistriesResult');
