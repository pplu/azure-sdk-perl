package Azure::StorSimpleSeries8000Management::CreateOrUpdateManagers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimpleSeries8000Management::Manager',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimpleSeries8000Management::CreateOrUpdateManagersResult');
