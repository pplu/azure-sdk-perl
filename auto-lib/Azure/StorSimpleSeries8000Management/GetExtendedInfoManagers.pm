package Azure::StorSimpleSeries8000Management::GetExtendedInfoManagers;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimpleSeries8000Management::GetExtendedInfoManagersResult');
