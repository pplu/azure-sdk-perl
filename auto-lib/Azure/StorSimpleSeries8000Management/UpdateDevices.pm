package Azure::StorSimpleSeries8000Management::UpdateDevices;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimpleSeries8000Management::DevicePatch',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimpleSeries8000Management::UpdateDevicesResult');
