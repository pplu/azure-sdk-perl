package Azure::StorSimpleSeries8000Management::GetDevicePublicEncryptionKeyManagers;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimpleSeries8000Management::GetDevicePublicEncryptionKeyManagersResult');
