package Azure::StorSimpleSeries8000Management::CreateExtendedInfoManagers;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimpleSeries8000Management::CreateExtendedInfoManagersResult');
