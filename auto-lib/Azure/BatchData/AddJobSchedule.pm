package Azure::BatchData::AddJobSchedule;
  use Moose;
  ...
  has 'cloudJobSchedule' => (is => 'ro', required => 1, isa => 'Azure::BatchData::JobScheduleAddParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::AddJobScheduleResult',
