package Azure::BatchData::ListNodeAgentSkusAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchData::ListNodeAgentSkusAccountResult',
    
      default => 'Azure::BatchData::ListNodeAgentSkusAccountResult',
