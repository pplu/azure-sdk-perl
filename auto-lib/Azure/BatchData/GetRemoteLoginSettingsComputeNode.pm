package Azure::BatchData::GetRemoteLoginSettingsComputeNode;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchData::GetRemoteLoginSettingsComputeNodeResult',
    
      default => 'Azure::BatchData::GetRemoteLoginSettingsComputeNodeResult',
