package Azure::BatchData::ListPoolNodeCountsAccount;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/nodecounts');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::BatchData::ListPoolNodeCountsAccountResult',
    
      default => 'Azure::BatchData::ListPoolNodeCountsAccountResult',
