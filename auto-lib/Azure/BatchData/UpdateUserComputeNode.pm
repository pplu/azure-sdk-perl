package Azure::BatchData::UpdateUserComputeNode;
  use Moose;
  ...
  has 'nodeUpdateUserParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::NodeUpdateUserParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::UpdateUserComputeNodeResult',
