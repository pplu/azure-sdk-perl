package Azure::BatchData::GetRemoteDesktopComputeNode;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchData::GetRemoteDesktopComputeNodeResult',
    
      default => 'Azure::BatchData::GetRemoteDesktopComputeNodeResult',
