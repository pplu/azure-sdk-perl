package Azure::BatchData::UpdateJob;
  use Moose;
  ...
  has 'jobUpdateParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::JobUpdateParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::UpdateJobResult',
