package Azure::BatchData::RemoveNodesPool;
  use Moose;
  ...
  has 'nodeRemoveParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::NodeRemoveParameter',
  ...
  class_has _api_uri => (is => 'ro', default => '/pools/{poolId}/removenodes');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      202 => undef,
    
      default => 'Azure::BatchData::RemoveNodesPoolResult',
