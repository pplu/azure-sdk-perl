package Azure::BatchData::RebootComputeNode;
  use Moose;
  ...
  has 'nodeRebootParameter' => (is => 'ro', isa => 'Azure::BatchData::NodeRebootParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::RebootComputeNodeResult',
