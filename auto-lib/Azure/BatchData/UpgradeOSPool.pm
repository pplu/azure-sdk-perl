package Azure::BatchData::UpgradeOSPool;
  use Moose;
  ...
  has 'poolUpgradeOSParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::PoolUpgradeOSParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::UpgradeOSPoolResult',
