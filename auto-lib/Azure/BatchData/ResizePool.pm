package Azure::BatchData::ResizePool;
  use Moose;
  ...
  has 'poolResizeParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::PoolResizeParameter',
  ...
  class_has _api_uri => (is => 'ro', default => '/pools/{poolId}/resize');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      202 => undef,
    
      default => 'Azure::BatchData::ResizePoolResult',
