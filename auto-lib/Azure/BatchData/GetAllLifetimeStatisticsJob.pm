package Azure::BatchData::GetAllLifetimeStatisticsJob;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchData::GetAllLifetimeStatisticsJobResult',
    
      default => 'Azure::BatchData::GetAllLifetimeStatisticsJobResult',
