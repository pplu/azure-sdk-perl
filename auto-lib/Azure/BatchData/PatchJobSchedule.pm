package Azure::BatchData::PatchJobSchedule;
  use Moose;
  ...
  has 'jobSchedulePatchParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::JobSchedulePatchParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::PatchJobScheduleResult',
