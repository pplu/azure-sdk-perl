package Azure::BatchData::AddUserComputeNode;
  use Moose;
  ...
  has 'user' => (is => 'ro', required => 1, isa => 'Azure::BatchData::ComputeNodeUser',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::AddUserComputeNodeResult',
