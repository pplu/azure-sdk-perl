package Azure::BatchData::EnableAutoScalePool;
  use Moose;
  ...
  has 'poolEnableAutoScaleParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::PoolEnableAutoScaleParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::EnableAutoScalePoolResult',
