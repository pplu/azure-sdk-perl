package Azure::BatchData::ListPreparationAndReleaseTaskStatusJob;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchData::ListPreparationAndReleaseTaskStatusJobResult',
    
      default => 'Azure::BatchData::ListPreparationAndReleaseTaskStatusJobResult',
