package Azure::BatchData::UpdateTask;
  use Moose;
  ...
  has 'taskUpdateParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::TaskUpdateParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::UpdateTaskResult',
