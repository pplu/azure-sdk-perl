package Azure::BatchData::EvaluateAutoScalePool;
  use Moose;
  ...
  has 'poolEvaluateAutoScaleParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::PoolEvaluateAutoScaleParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchData::EvaluateAutoScalePoolResult',
    
      default => 'Azure::BatchData::EvaluateAutoScalePoolResult',
