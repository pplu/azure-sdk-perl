package Azure::BatchData::UpdateJobSchedule;
  use Moose;
  ...
  has 'jobScheduleUpdateParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::JobScheduleUpdateParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::UpdateJobScheduleResult',
