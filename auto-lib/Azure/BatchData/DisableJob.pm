package Azure::BatchData::DisableJob;
  use Moose;
  ...
  has 'jobDisableParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::JobDisableParameter',
  ...
  class_has _api_uri => (is => 'ro', default => '/jobs/{jobId}/disable');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      202 => undef,
    
      default => 'Azure::BatchData::DisableJobResult',
