package Azure::BatchData::UploadBatchServiceLogsComputeNode;
  use Moose;
  ...
  has 'uploadBatchServiceLogsConfiguration' => (is => 'ro', required => 1, isa => 'Azure::BatchData::UploadBatchServiceLogsConfiguration',
    traits => [ 'Azure::ParamInBody' ],
  );

  class_has _api_uri => (is => 'ro', default => '/pools/{poolId}/nodes/{nodeId}/uploadbatchservicelogs');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::BatchData::UploadBatchServiceLogsComputeNodeResult',
    
      default => 'Azure::BatchData::UploadBatchServiceLogsComputeNodeResult',
