package Azure::BatchData::TerminateJob;
  use Moose;
  ...
  has 'jobTerminateParameter' => (is => 'ro', isa => 'Azure::BatchData::JobTerminateParameter',
  ...
  class_has _api_uri => (is => 'ro', default => '/jobs/{jobId}/terminate');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      202 => undef,
    
      default => 'Azure::BatchData::TerminateJobResult',
