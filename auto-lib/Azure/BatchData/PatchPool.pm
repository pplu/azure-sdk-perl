package Azure::BatchData::PatchPool;
  use Moose;
  ...
  has 'poolPatchParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchData::PoolPatchParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::BatchData::PatchPoolResult',
