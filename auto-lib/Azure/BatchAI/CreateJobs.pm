package Azure::BatchAI::CreateJobs;
  ...
  class_has _api_uri => (is => 'ro', default => '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BatchAI/workspaces/{workspaceName}/experiments/{experimentName}/jobs/{jobName}');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::BatchAI::CreateJobsResult',
    
      202 => undef,
    
      default => 'Azure::BatchAI::CreateJobsResult',
