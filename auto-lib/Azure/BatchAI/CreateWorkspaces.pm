package Azure::BatchAI::CreateWorkspaces;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::BatchAI::WorkspaceCreateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchAI::CreateWorkspacesResult',
    
      202 => undef,
    
      default => 'Azure::BatchAI::CreateWorkspacesResult',
