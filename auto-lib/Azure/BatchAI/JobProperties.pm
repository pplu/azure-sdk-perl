package Azure::BatchAI::JobProperties;
  use Moose;
  ...
  has 'constraints' => (is => 'ro', isa => 'Azure::BatchAI::JobProperties_constraints'  );
  ...
  has 'executionInfo' => (is => 'ro', isa => 'Azure::BatchAI::JobProperties_executionInfo'  );
