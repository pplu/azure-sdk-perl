package Azure::RecoveryServices::InMageAzureV2ReplicationDetails;
  use Moose;
  ...
  has 'protectedDisks' => (is => 'ro', isa => 'ArrayRef[Azure::RecoveryServices::InMageAzureV2ProtectedDiskDetails]'  );
