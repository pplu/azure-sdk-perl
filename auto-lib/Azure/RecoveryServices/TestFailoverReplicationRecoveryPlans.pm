package Azure::RecoveryServices::TestFailoverReplicationRecoveryPlans;
  use Moose;
  ...
  has 'input' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::RecoveryPlanTestFailoverInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::TestFailoverReplicationRecoveryPlansResult',
