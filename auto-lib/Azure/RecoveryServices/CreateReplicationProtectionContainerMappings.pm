package Azure::RecoveryServices::CreateReplicationProtectionContainerMappings;
  use Moose;
  ...
  has 'creationInput' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::CreateProtectionContainerMappingInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::CreateReplicationProtectionContainerMappingsResult',
