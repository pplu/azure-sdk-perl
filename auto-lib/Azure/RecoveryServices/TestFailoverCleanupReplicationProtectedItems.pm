package Azure::RecoveryServices::TestFailoverCleanupReplicationProtectedItems;
  use Moose;
  ...
  has 'cleanupInput' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::TestFailoverCleanupInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::TestFailoverCleanupReplicationProtectedItemsResult',
