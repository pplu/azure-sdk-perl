package Azure::RecoveryServices::A2AReplicationDetails;
  use Moose;
  ...
  has 'protectedDisks' => (is => 'ro', isa => 'ArrayRef[Azure::RecoveryServices::A2AProtectedDiskDetails]'  );
  has 'protectedManagedDisks' => (is => 'ro', isa => 'ArrayRef[Azure::RecoveryServices::A2AProtectedManagedDiskDetails]'  );
  ...
  has 'vmSyncedConfigDetails' => (is => 'ro', isa => 'Azure::RecoveryServices::AzureToAzureVmSyncedConfigDetails'  );
