package Azure::RecoveryServices::UpdateVaults;
  ...
  has 'vault' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::PatchVault',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::UpdateVaultsResult',
    
      201 => 'Azure::RecoveryServices::UpdateVaultsResult',
