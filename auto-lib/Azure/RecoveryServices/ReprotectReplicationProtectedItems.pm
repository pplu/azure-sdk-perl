package Azure::RecoveryServices::ReprotectReplicationProtectedItems;
  use Moose;
  ...
  has 'rrInput' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::ReverseReplicationInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::ReprotectReplicationProtectedItemsResult',
