package Azure::RecoveryServices::UpdateReplicationvCenters;
  use Moose;
  ...
  has 'updateVCenterRequest' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::UpdateVCenterRequest',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::UpdateReplicationvCentersResult',
