package Azure::RecoveryServices::UpdateReplicationProtectionContainerMappings;
  use Moose;
  ...
  has 'updateInput' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::UpdateProtectionContainerMappingInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::UpdateReplicationProtectionContainerMappingsResult',
