package Azure::RecoveryServices::CreateReplicationPolicies;
  use Moose;
  ...
  has 'input' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::CreatePolicyInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::CreateReplicationPoliciesResult',
