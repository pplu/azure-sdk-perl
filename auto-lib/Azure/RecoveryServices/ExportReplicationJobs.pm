package Azure::RecoveryServices::ExportReplicationJobs;
  use Moose;
  ...
  has 'jobQueryParameter' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::JobQueryParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::ExportReplicationJobsResult',
