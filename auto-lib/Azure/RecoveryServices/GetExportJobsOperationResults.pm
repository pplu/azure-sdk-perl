package Azure::RecoveryServices::GetExportJobsOperationResults;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::GetExportJobsOperationResultsResult',
    
      202 => 'Azure::RecoveryServices::GetExportJobsOperationResultsResult',
