package Azure::RecoveryServices::TestFailoverCleanupReplicationRecoveryPlans;
  use Moose;
  ...
  has 'input' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::RecoveryPlanTestFailoverCleanupInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::TestFailoverCleanupReplicationRecoveryPlansResult',
