package Azure::RecoveryServices::SwitchProtectionReplicationProtectionContainers;
  use Moose;
  ...
  has 'switchInput' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::SwitchProtectionInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::SwitchProtectionReplicationProtectionContainersResult',
