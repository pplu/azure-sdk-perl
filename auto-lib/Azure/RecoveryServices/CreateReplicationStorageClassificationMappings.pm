package Azure::RecoveryServices::CreateReplicationStorageClassificationMappings;
  use Moose;
  ...
  has 'pairingInput' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::StorageClassificationMappingInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::CreateReplicationStorageClassificationMappingsResult',
