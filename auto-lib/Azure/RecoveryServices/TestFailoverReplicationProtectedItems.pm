package Azure::RecoveryServices::TestFailoverReplicationProtectedItems;
  use Moose;
  ...
  has 'failoverInput' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::TestFailoverInput',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::TestFailoverReplicationProtectedItemsResult',
