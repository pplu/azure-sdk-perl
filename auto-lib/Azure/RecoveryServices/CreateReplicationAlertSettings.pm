package Azure::RecoveryServices::CreateReplicationAlertSettings;
  use Moose;
  ...
  has 'request' => (is => 'ro', required => 1, isa => 'Azure::RecoveryServices::ConfigureAlertRequest',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::CreateReplicationAlertSettingsResult',
