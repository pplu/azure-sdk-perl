package Azure::RecoveryServices::ListByReplicationStorageClassificationsReplicationStorageClassificationMappings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::RecoveryServices::ListByReplicationStorageClassificationsReplicationStorageClassificationMappingsResult',
