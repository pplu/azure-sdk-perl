package Azure::RecoveryServices::MabJob;
  use Moose;

  has 'actionsInfo' => (is => 'ro', isa => 'ArrayRef[Str]'  );
  has 'duration' => (is => 'ro', isa => 'Str'  );
  has 'errorDetails' => (is => 'ro', isa => 'ArrayRef[Azure::RecoveryServices::MabErrorInfo]'  );
  has 'extendedInfo' => (is => 'ro', isa => 'Azure::RecoveryServices::MabJobExtendedInfo'  );
