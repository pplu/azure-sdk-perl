package Azure::DevTestLab::ListBySubscriptionGlobalSchedules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::ListBySubscriptionGlobalSchedulesResult',
    
      default => 'Azure::DevTestLab::ListBySubscriptionGlobalSchedulesResult',
