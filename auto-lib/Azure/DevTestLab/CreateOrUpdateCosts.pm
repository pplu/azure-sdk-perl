package Azure::DevTestLab::CreateOrUpdateCosts;
  use Moose;
  ...
  has 'labCost' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::LabCost',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::CreateOrUpdateCostsResult',
    
      201 => 'Azure::DevTestLab::CreateOrUpdateCostsResult',
    
      default => 'Azure::DevTestLab::CreateOrUpdateCostsResult',
