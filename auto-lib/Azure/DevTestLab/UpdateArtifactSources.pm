package Azure::DevTestLab::UpdateArtifactSources;
  use Moose;
  ...
  has 'artifactSource' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::ArtifactSourceFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateArtifactSourcesResult',
    
      default => 'Azure::DevTestLab::UpdateArtifactSourcesResult',
