package Azure::DevTestLab::UpdateNotificationChannels;
  use Moose;
  ...
  has 'notificationChannel' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::NotificationChannelFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateNotificationChannelsResult',
    
      default => 'Azure::DevTestLab::UpdateNotificationChannelsResult',
