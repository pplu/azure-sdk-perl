package Azure::DevTestLab::UpdateSecrets;
  use Moose;
  ...
  has 'secret' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::SecretFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateSecretsResult',
    
      default => 'Azure::DevTestLab::UpdateSecretsResult',
