package Azure::DevTestLab::GenerateArmTemplateArtifacts;
  use Moose;
  ...
  has 'generateArmTemplateRequest' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::GenerateArmTemplateRequest',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::GenerateArmTemplateArtifactsResult',
    
      default => 'Azure::DevTestLab::GenerateArmTemplateArtifactsResult',
