package Azure::DevTestLab::UpdatePolicies;
  use Moose;
  ...
  has 'policy' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::PolicyFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdatePoliciesResult',
    
      default => 'Azure::DevTestLab::UpdatePoliciesResult',
