package Azure::DevTestLab::UpdateDisks;
  use Moose;
  ...
  has 'disk' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::DiskFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateDisksResult',
    
      default => 'Azure::DevTestLab::UpdateDisksResult',
