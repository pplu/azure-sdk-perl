package Azure::DevTestLab::GetVirtualMachineSchedules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::GetVirtualMachineSchedulesResult',
    
      default => 'Azure::DevTestLab::GetVirtualMachineSchedulesResult',
