package Azure::DevTestLab::CreateOrUpdateUsers;
  use Moose;
  ...
  has 'user' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::User',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::CreateOrUpdateUsersResult',
    
      201 => 'Azure::DevTestLab::CreateOrUpdateUsersResult',
    
      default => 'Azure::DevTestLab::CreateOrUpdateUsersResult',
