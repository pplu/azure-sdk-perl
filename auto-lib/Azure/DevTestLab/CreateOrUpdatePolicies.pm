package Azure::DevTestLab::CreateOrUpdatePolicies;
  use Moose;
  ...
  has 'policy' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::Policy',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::CreateOrUpdatePoliciesResult',
    
      201 => 'Azure::DevTestLab::CreateOrUpdatePoliciesResult',
    
      default => 'Azure::DevTestLab::CreateOrUpdatePoliciesResult',
