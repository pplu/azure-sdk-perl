package Azure::DevTestLab::UpdateVirtualMachines;
  use Moose;
  ...
  has 'labVirtualMachine' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::LabVirtualMachineFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateVirtualMachinesResult',
    
      default => 'Azure::DevTestLab::UpdateVirtualMachinesResult',
