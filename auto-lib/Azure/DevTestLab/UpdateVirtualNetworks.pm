package Azure::DevTestLab::UpdateVirtualNetworks;
  use Moose;
  ...
  has 'virtualNetwork' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::VirtualNetworkFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateVirtualNetworksResult',
    
      default => 'Azure::DevTestLab::UpdateVirtualNetworksResult',
