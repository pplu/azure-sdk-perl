package Azure::DevTestLab::RetargetGlobalSchedules;
  use Moose;
  ...
  has 'retargetScheduleProperties' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::RetargetScheduleProperties',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::DevTestLab::RetargetGlobalSchedulesResult',
