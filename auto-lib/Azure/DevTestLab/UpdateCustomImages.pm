package Azure::DevTestLab::UpdateCustomImages;
  use Moose;
  ...
  has 'customImage' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::CustomImageFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateCustomImagesResult',
    
      default => 'Azure::DevTestLab::UpdateCustomImagesResult',
