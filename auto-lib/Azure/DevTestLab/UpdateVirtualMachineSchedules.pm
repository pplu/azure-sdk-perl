package Azure::DevTestLab::UpdateVirtualMachineSchedules;
  use Moose;
  ...
  has 'schedule' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::ScheduleFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateVirtualMachineSchedulesResult',
    
      default => 'Azure::DevTestLab::UpdateVirtualMachineSchedulesResult',
