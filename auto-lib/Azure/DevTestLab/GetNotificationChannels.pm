package Azure::DevTestLab::GetNotificationChannels;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::GetNotificationChannelsResult',
    
      default => 'Azure::DevTestLab::GetNotificationChannelsResult',
