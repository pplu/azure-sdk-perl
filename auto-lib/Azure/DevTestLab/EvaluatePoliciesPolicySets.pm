package Azure::DevTestLab::EvaluatePoliciesPolicySets;
  use Moose;
  ...
  has 'evaluatePoliciesRequest' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::EvaluatePoliciesRequest',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::EvaluatePoliciesPolicySetsResult',
    
      default => 'Azure::DevTestLab::EvaluatePoliciesPolicySetsResult',
