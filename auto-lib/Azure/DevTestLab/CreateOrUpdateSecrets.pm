package Azure::DevTestLab::CreateOrUpdateSecrets;
  use Moose;
  ...
  has 'secret' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::Secret',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::CreateOrUpdateSecretsResult',
    
      201 => 'Azure::DevTestLab::CreateOrUpdateSecretsResult',
    
      default => 'Azure::DevTestLab::CreateOrUpdateSecretsResult',
