package Azure::DevTestLab::UpdateLabs;
  use Moose;
  ...
  has 'lab' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::LabFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::UpdateLabsResult',
    
      default => 'Azure::DevTestLab::UpdateLabsResult',
