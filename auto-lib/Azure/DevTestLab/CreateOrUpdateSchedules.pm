package Azure::DevTestLab::CreateOrUpdateSchedules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLab::CreateOrUpdateSchedulesResult',
    
      201 => 'Azure::DevTestLab::CreateOrUpdateSchedulesResult',
    
      default => 'Azure::DevTestLab::CreateOrUpdateSchedulesResult',
