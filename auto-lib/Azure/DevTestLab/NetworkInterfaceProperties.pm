package Azure::DevTestLab::NetworkInterfaceProperties;
  use Moose;
  ...
  has 'sharedPublicIpAddressConfiguration' => (is => 'ro', isa => 'Azure::DevTestLab::SharedPublicIpAddressConfiguration'  );
