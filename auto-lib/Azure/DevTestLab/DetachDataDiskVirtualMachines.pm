package Azure::DevTestLab::DetachDataDiskVirtualMachines;
  use Moose;
  ...
  has 'detachDataDiskProperties' => (is => 'ro', required => 1, isa => 'Azure::DevTestLab::DetachDataDiskProperties',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::DevTestLab::DetachDataDiskVirtualMachinesResult',
