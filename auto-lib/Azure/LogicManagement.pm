package Azure::LogicManagement;
  ...
  sub ListCallbackUrlWorkflowVersions {
    ...
    my $call_object = $self->new_with_coercions('Azure::LogicManagement::ListCallbackUrlWorkflowVersions', { @_ });
    return $self->caller->do_call($self, $call_object);
  }
  sub ListOperations {
    my $self = shift;
  ...
  sub ListSwaggerWorkflows {
    ...
    my $call_object = $self->new_with_coercions('Azure::LogicManagement::ListSwaggerWorkflows', { @_ });
    return $self->caller->do_call($self, $call_object);
  }
  ...
  sub RegenerateAccessKeyWorkflows {
    ...
    my $call_object = $self->new_with_coercions('Azure::LogicManagement::RegenerateAccessKeyWorkflows', { @_ });
    return $self->caller->do_call($self, $call_object);
  }
  sub ResubmitWorkflowTriggerHistories {
    ...
    my $call_object = $self->new_with_coercions('Azure::LogicManagement::ResubmitWorkflowTriggerHistories', { @_ });
    return $self->caller->do_call($self, $call_object);
  }
