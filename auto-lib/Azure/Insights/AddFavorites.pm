package Azure::Insights::AddFavorites;
  use Moose;
  ...
  has 'favoriteProperties' => (is => 'ro', required => 1, isa => 'Azure::Insights::ApplicationInsightsComponentFavorite',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Insights::AddFavoritesResult',
