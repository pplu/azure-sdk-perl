package Azure::Insights::UpdateTagsComponents;
  use Moose;
  use MooseX::ClassAttribute;

  has 'ComponentTags' => (is => 'ro', required => 1, isa => 'Azure::Insights::TagsResource',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Insights::UpdateTagsComponentsResult',
