package Azure::Insights::CreateOrUpdateComponents;
  use Moose;
  use MooseX::ClassAttribute;

  has 'InsightProperties' => (is => 'ro', required => 1, isa => 'Azure::Insights::ApplicationInsightsComponent',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Insights::CreateOrUpdateComponentsResult',
