package Azure::CdnManagement::UpdateEndpoints;
  ...
  has 'endpointUpdateProperties' => (is => 'ro', required => 1, isa => 'Azure::CdnManagement::EndpointUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CdnManagement::UpdateEndpointsResult',
    
      202 => 'Azure::CdnManagement::UpdateEndpointsResult',
    
      default => 'Azure::CdnManagement::UpdateEndpointsResult',
