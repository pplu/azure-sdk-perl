package Azure::CdnManagement::CreateProfiles;
  ...
  has 'profile' => (is => 'ro', required => 1, isa => 'Azure::CdnManagement::Profile',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CdnManagement::CreateProfilesResult',
    
      201 => 'Azure::CdnManagement::CreateProfilesResult',
    
      202 => 'Azure::CdnManagement::CreateProfilesResult',
    
      default => 'Azure::CdnManagement::CreateProfilesResult',
