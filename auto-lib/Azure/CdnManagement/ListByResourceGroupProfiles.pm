package Azure::CdnManagement::ListByResourceGroupProfiles;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CdnManagement::ListByResourceGroupProfilesResult',
    
      default => 'Azure::CdnManagement::ListByResourceGroupProfilesResult',
