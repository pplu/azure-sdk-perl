package Azure::CdnManagement::DisableCustomHttpsCustomDomains;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      202 => 'Azure::CdnManagement::DisableCustomHttpsCustomDomainsResult',
    
      default => 'Azure::CdnManagement::DisableCustomHttpsCustomDomainsResult',
