package Azure::CdnManagement::CreateEndpoints;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CdnManagement::CreateEndpointsResult',
    
      201 => 'Azure::CdnManagement::CreateEndpointsResult',
    
      202 => 'Azure::CdnManagement::CreateEndpointsResult',
    
      default => 'Azure::CdnManagement::CreateEndpointsResult',
