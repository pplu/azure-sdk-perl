package Azure::MLWebServicesManagement::ListInResourceGroupWebServices;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::MLWebServicesManagement::ListInResourceGroupWebServicesResult');
