package Azure::Compute::CreateOrUpdateVirtualMachines;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Compute::VirtualMachine',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Compute::CreateOrUpdateVirtualMachinesResult',
    
      201 => 'Azure::Compute::CreateOrUpdateVirtualMachinesResult',
