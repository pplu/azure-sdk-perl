package Azure::Compute::UpdateVirtualMachineScaleSetVMs;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Compute::VirtualMachineScaleSetVM',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Compute::UpdateVirtualMachineScaleSetVMsResult',
    
      202 => 'Azure::Compute::UpdateVirtualMachineScaleSetVMsResult',
