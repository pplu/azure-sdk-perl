package Azure::Compute::UpdateVirtualMachines;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Compute::VirtualMachineUpdate',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Compute::UpdateVirtualMachinesResult',
    
      201 => 'Azure::Compute::UpdateVirtualMachinesResult',
