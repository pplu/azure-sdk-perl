package Azure::Compute::CreateOrUpdateVirtualMachineScaleSets;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Compute::VirtualMachineScaleSet',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Compute::CreateOrUpdateVirtualMachineScaleSetsResult',
    
      201 => 'Azure::Compute::CreateOrUpdateVirtualMachineScaleSetsResult',
