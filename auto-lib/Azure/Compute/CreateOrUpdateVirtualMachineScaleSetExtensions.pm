package Azure::Compute::CreateOrUpdateVirtualMachineScaleSetExtensions;
  use Moose;
  ...
  has 'extensionParameters' => (is => 'ro', required => 1, isa => 'Azure::Compute::VirtualMachineScaleSetExtension',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Compute::CreateOrUpdateVirtualMachineScaleSetExtensionsResult',
    
      201 => 'Azure::Compute::CreateOrUpdateVirtualMachineScaleSetExtensionsResult',
