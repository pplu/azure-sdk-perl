package Azure::Compute::CaptureVirtualMachines;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Compute::VirtualMachineCaptureParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Compute::CaptureVirtualMachinesResult',
