package Azure::SearchManagement::CreateOrUpdateServices;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::SearchManagement::CreateOrUpdateServicesResult',
    
      201 => 'Azure::SearchManagement::CreateOrUpdateServicesResult',
    
      default => 'Azure::SearchManagement::CreateOrUpdateServicesResult',
