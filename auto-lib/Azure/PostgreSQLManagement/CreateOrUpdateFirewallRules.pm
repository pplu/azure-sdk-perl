package Azure::PostgreSQLManagement::CreateOrUpdateFirewallRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::PostgreSQLManagement::FirewallRule',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PostgreSQLManagement::CreateOrUpdateFirewallRulesResult',
    
      201 => 'Azure::PostgreSQLManagement::CreateOrUpdateFirewallRulesResult',
