package Azure::PostgreSQLManagement::CreateOrUpdateConfigurations;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::PostgreSQLManagement::Configuration',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::PostgreSQLManagement::CreateOrUpdateConfigurationsResult');
