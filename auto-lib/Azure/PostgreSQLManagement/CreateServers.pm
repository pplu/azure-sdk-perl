package Azure::PostgreSQLManagement::CreateServers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::PostgreSQLManagement::ServerForCreate',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PostgreSQLManagement::CreateServersResult',
    
      201 => 'Azure::PostgreSQLManagement::CreateServersResult',
