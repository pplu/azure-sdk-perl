package Azure::PostgreSQLManagement::ListByServerFirewallRules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::PostgreSQLManagement::ListByServerFirewallRulesResult');
