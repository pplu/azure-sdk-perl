package Azure::DataLakeAnalyticsCatalogManagement::UpdateCredentialCatalog;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DataLakeAnalyticsCatalogManagement::DataLakeAnalyticsCatalogCredentialUpdateParameters',
