package Azure::ServiceFabricManagement;
  ...
  sub operations { qw/CreateClusters DeleteClusters GetClusters ListByResourceGroupClusters ListClusters ListClusterVersions ListOperations UpdateClusters / }
