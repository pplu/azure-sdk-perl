package Azure::AppServicePlans::GetRouteForVnetAppServicePlans;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AppServicePlans::GetRouteForVnetAppServicePlansResult');
