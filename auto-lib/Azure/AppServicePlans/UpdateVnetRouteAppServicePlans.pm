package Azure::AppServicePlans::UpdateVnetRouteAppServicePlans;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AppServicePlans::UpdateVnetRouteAppServicePlansResult');
