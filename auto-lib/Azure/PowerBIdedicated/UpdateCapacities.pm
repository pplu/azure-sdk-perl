package Azure::PowerBIdedicated::UpdateCapacities;
  use Moose;
  ...
  has 'capacityUpdateParameters' => (is => 'ro', required => 1, isa => 'Azure::PowerBIdedicated::DedicatedCapacityUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::PowerBIdedicated::UpdateCapacitiesResult',
    
      202 => 'Azure::PowerBIdedicated::UpdateCapacitiesResult',
