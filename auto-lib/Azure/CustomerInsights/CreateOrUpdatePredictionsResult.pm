package Azure::CustomerInsights::CreateOrUpdatePredictionsResult;
  use Moose;
  ...
  has mappings => (is => 'ro', isa => 'Azure::CustomerInsights::CreateOrUpdatePredictionsResult_mappings'  );
  ...
  has systemGeneratedEntities => (is => 'ro', isa => 'Azure::CustomerInsights::CreateOrUpdatePredictionsResult_systemGeneratedEntities'  );
