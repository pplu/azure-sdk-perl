package Azure::CustomerInsights::CreateOrUpdateInteractionsResult;
  use Moose;

  has id => (is => 'ro', isa => 'Str'  );
  has name => (is => 'ro', isa => 'Str'  );
  has type => (is => 'ro', isa => 'Str'  );
  has dataSourcePrecedenceRules => (is => 'ro', isa => 'ArrayRef[Azure::CustomerInsights::DataSourcePrecedence]'  );
  has idPropertyNames => (is => 'ro', isa => 'ArrayRef[Str]'  );
  has isActivity => (is => 'ro', isa => 'Bool'  );
  has participantProfiles => (is => 'ro', isa => 'ArrayRef[Azure::CustomerInsights::Participant]'  );
