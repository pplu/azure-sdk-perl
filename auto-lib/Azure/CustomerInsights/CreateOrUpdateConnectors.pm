package Azure::CustomerInsights::CreateOrUpdateConnectors;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::CustomerInsights::ConnectorResourceFormat',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CustomerInsights::CreateOrUpdateConnectorsResult',
