package Azure::CustomerInsights::CreateOrUpdateConnectorMappings;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::CustomerInsights::ConnectorMappingResourceFormat',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CustomerInsights::CreateOrUpdateConnectorMappingsResult',
    
      201 => 'Azure::CustomerInsights::CreateOrUpdateConnectorMappingsResult',
