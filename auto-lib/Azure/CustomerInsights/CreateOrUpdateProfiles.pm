package Azure::CustomerInsights::CreateOrUpdateProfiles;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::CustomerInsights::ProfileResourceFormat',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CustomerInsights::CreateOrUpdateProfilesResult',
