package Azure::CustomerInsights::CreateOrUpdateRoleAssignments;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::CustomerInsights::RoleAssignmentResourceFormat',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CustomerInsights::CreateOrUpdateRoleAssignmentsResult',
