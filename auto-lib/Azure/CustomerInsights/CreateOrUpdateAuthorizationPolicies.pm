package Azure::CustomerInsights::CreateOrUpdateAuthorizationPolicies;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::CustomerInsights::AuthorizationPolicyResourceFormat',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CustomerInsights::CreateOrUpdateAuthorizationPoliciesResult',
    
      201 => 'Azure::CustomerInsights::CreateOrUpdateAuthorizationPoliciesResult',
