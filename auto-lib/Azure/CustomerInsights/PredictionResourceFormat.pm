package Azure::CustomerInsights::PredictionResourceFormat;
  use Moose;
  ...
  has 'mappings' => (is => 'ro', isa => 'Azure::CustomerInsights::PredictionResourceFormat_mappings'  );
  ...
  has 'systemGeneratedEntities' => (is => 'ro', isa => 'Azure::CustomerInsights::PredictionResourceFormat_systemGeneratedEntities'  );
