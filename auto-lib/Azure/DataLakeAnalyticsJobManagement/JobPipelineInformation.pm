package Azure::DataLakeAnalyticsJobManagement::JobPipelineInformation;
  use Moose;
  ...
  has 'runs' => (is => 'ro', isa => 'ArrayRef[Azure::DataLakeAnalyticsJobManagement::JobPipelineRunInformation]'  );
1;
