package Azure::DataMigration::CreateOrUpdateTasks;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataMigration::CreateOrUpdateTasksResult',
    
      201 => 'Azure::DataMigration::CreateOrUpdateTasksResult',
    
      default => 'Azure::DataMigration::CreateOrUpdateTasksResult',
