package Azure::DataMigration::CreateOrUpdateProjects;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataMigration::CreateOrUpdateProjectsResult',
    
      201 => 'Azure::DataMigration::CreateOrUpdateProjectsResult',
    
      default => 'Azure::DataMigration::CreateOrUpdateProjectsResult',
