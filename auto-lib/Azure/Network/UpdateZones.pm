package Azure::Network::UpdateZones;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::ZoneUpdate',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::UpdateZonesResult',
    
      default => 'Azure::Network::UpdateZonesResult',
