package Azure::Network::GetTrafficManagerUserMetricsKeys;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::GetTrafficManagerUserMetricsKeysResult',
    
      default => 'Azure::Network::GetTrafficManagerUserMetricsKeysResult',
