package Azure::Network::VpnDeviceConfigurationScriptVirtualNetworkGateways;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::VpnDeviceScriptParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::VpnDeviceConfigurationScriptVirtualNetworkGatewaysResult',
