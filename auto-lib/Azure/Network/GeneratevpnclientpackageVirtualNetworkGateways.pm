package Azure::Network::GeneratevpnclientpackageVirtualNetworkGateways;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::VpnClientParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::GeneratevpnclientpackageVirtualNetworkGatewaysResult',
