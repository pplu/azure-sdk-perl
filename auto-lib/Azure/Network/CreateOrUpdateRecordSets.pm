package Azure::Network::CreateOrUpdateRecordSets;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::RecordSet',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::CreateOrUpdateRecordSetsResult',
    
      201 => 'Azure::Network::CreateOrUpdateRecordSetsResult',
    
      default => 'Azure::Network::CreateOrUpdateRecordSetsResult',
