package Azure::Network::CreateOrUpdateSecurityRulesResult;
  use Moose;
  ...
  has destinationApplicationSecurityGroups => (is => 'ro', isa => 'ArrayRef[Azure::Network::ApplicationSecurityGroup]'  );
  ...
  has sourceApplicationSecurityGroups => (is => 'ro', isa => 'ArrayRef[Azure::Network::ApplicationSecurityGroup]'  );
