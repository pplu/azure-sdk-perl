package Azure::Network::SetSharedKeyVirtualNetworkGatewayConnections;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::ConnectionSharedKey',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::SetSharedKeyVirtualNetworkGatewayConnectionsResult',
    
      201 => 'Azure::Network::SetSharedKeyVirtualNetworkGatewayConnectionsResult',
