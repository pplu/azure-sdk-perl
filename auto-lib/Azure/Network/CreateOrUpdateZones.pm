package Azure::Network::CreateOrUpdateZones;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::Zone',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::CreateOrUpdateZonesResult',
    
      201 => 'Azure::Network::CreateOrUpdateZonesResult',
    
      default => 'Azure::Network::CreateOrUpdateZonesResult',
