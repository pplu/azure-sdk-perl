package Azure::Network::CreatePacketCaptures;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::PacketCapture',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      201 => 'Azure::Network::CreatePacketCapturesResult',
    
      default => 'Azure::Network::CreatePacketCapturesResult',
