package Azure::Network::ListByResourceGroupProfiles;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::ListByResourceGroupProfilesResult',
    
      default => 'Azure::Network::ListByResourceGroupProfilesResult',
