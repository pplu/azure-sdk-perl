package Azure::Network::CreateOrUpdateExpressRouteCrossConnections;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::ExpressRouteCrossConnection',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::CreateOrUpdateExpressRouteCrossConnectionsResult',
