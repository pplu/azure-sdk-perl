package Azure::Network::CreateOrUpdateEndpoints;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::Endpoint',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::CreateOrUpdateEndpointsResult',
    
      201 => 'Azure::Network::CreateOrUpdateEndpointsResult',
    
      default => 'Azure::Network::CreateOrUpdateEndpointsResult',
