package Azure::Network::ResetSharedKeyVirtualNetworkGatewayConnections;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::ConnectionResetSharedKey',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::ResetSharedKeyVirtualNetworkGatewayConnectionsResult',
