package Azure::Network::CreateOrUpdateProfiles;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::Profile',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::CreateOrUpdateProfilesResult',
    
      201 => 'Azure::Network::CreateOrUpdateProfilesResult',
    
      default => 'Azure::Network::CreateOrUpdateProfilesResult',
