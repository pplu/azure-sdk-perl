package Azure::Network::CreateOrUpdateApplicationGateways;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::ApplicationGateway',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::CreateOrUpdateApplicationGatewaysResult',
    
      201 => 'Azure::Network::CreateOrUpdateApplicationGatewaysResult',
