package Azure::Network::CreateOrUpdateVirtualNetworkGateways;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::VirtualNetworkGateway',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::CreateOrUpdateVirtualNetworkGatewaysResult',
    
      201 => 'Azure::Network::CreateOrUpdateVirtualNetworkGatewaysResult',
