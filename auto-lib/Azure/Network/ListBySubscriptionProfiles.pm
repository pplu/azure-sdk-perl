package Azure::Network::ListBySubscriptionProfiles;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::ListBySubscriptionProfilesResult',
    
      default => 'Azure::Network::ListBySubscriptionProfilesResult',
