package Azure::Network::CreateOrUpdateLocalNetworkGateways;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Network::LocalNetworkGateway',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Network::CreateOrUpdateLocalNetworkGatewaysResult',
    
      201 => 'Azure::Network::CreateOrUpdateLocalNetworkGatewaysResult',
