package Azure::EventGridManagement::CreateOrUpdateTopics;
  use Moose;
  ...
  has 'topicInfo' => (is => 'ro', required => 1, isa => 'Azure::EventGridManagement::Topic',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::EventGridManagement::CreateOrUpdateTopicsResult');
