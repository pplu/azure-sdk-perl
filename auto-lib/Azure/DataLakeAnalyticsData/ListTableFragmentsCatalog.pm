package Azure::DataLakeAnalyticsData::ListTableFragmentsCatalog;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/catalog/usql/databases/{databaseName}/schemas/{schemaName}/tables/{tableName}/tablefragments');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::DataLakeAnalyticsData::ListTableFragmentsCatalogResult',
