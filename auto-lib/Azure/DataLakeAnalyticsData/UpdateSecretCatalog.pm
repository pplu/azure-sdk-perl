package Azure::DataLakeAnalyticsData::UpdateSecretCatalog;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DataLakeAnalyticsData::DataLakeAnalyticsCatalogSecretCreateOrUpdateParameters',
