package Azure::DataLakeAnalyticsData::DeleteCredentialCatalog;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::DataLakeAnalyticsData::DataLakeAnalyticsCatalogCredentialDeleteParameters',
