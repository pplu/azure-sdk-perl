package Azure::DataLakeAnalyticsData::UpdateCredentialCatalog;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DataLakeAnalyticsData::DataLakeAnalyticsCatalogCredentialUpdateParameters',
