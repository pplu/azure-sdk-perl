package Azure::Policy::GetAtManagementGroupPolicySetDefinitions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::Policy::GetAtManagementGroupPolicySetDefinitionsResult');
