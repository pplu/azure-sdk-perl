package Azure::StreamAnalytics::CreateOrReplaceFunctions;
  use Moose;
  ...
  has 'function' => (is => 'ro', required => 1, isa => 'Azure::StreamAnalytics::Function',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::StreamAnalytics::CreateOrReplaceFunctionsResult',
    
      201 => 'Azure::StreamAnalytics::CreateOrReplaceFunctionsResult',
