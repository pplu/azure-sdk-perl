package Azure::Batch::UpdatePool;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Batch::Pool',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Batch::UpdatePoolResult',
    
      default => 'Azure::Batch::UpdatePoolResult',
