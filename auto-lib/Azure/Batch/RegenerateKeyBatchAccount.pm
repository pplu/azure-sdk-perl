package Azure::Batch::RegenerateKeyBatchAccount;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Batch::BatchAccountRegenerateKeyParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Batch::RegenerateKeyBatchAccountResult',
    
      default => 'Azure::Batch::RegenerateKeyBatchAccountResult',
