package Azure::Authorization::ListPolicySetDefinitions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Authorization::ListPolicySetDefinitionsResult',
    
      default => 'Azure::Authorization::ListPolicySetDefinitionsResult',
