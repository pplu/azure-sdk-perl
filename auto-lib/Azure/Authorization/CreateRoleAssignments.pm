package Azure::Authorization::CreateRoleAssignments;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::Authorization::RoleAssignmentCreateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      201 => 'Azure::Authorization::CreateRoleAssignmentsResult',
