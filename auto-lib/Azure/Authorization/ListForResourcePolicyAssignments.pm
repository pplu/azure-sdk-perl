package Azure::Authorization::ListForResourcePolicyAssignments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Authorization::ListForResourcePolicyAssignmentsResult',
    
      default => 'Azure::Authorization::ListForResourcePolicyAssignmentsResult',
