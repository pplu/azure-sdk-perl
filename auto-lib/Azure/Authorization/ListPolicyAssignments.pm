package Azure::Authorization::ListPolicyAssignments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Authorization::ListPolicyAssignmentsResult',
    
      default => 'Azure::Authorization::ListPolicyAssignmentsResult',
