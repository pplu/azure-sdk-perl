package Azure::Authorization::GetPolicySetDefinitions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Authorization::GetPolicySetDefinitionsResult',
    
      default => 'Azure::Authorization::GetPolicySetDefinitionsResult',
