package Azure::SQLDatabase::ListMetricsRecommendedElasticPools;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SQLDatabase::ListMetricsRecommendedElasticPoolsResult');
