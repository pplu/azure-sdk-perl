package Azure::SQLDatabase::CreateOrUpdateDatabases;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::SQLDatabase::Database',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SQLDatabase::CreateOrUpdateDatabasesResult');
