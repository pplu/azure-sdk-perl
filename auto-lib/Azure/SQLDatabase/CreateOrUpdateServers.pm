package Azure::SQLDatabase::CreateOrUpdateServers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::SQLDatabase::Server',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SQLDatabase::CreateOrUpdateServersResult');
