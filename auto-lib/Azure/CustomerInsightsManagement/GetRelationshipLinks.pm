package Azure::CustomerInsightsManagement::GetRelationshipLinks;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::CustomerInsightsManagement::GetRelationshipLinksResult');
