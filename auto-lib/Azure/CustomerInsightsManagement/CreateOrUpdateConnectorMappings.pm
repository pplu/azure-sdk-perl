package Azure::CustomerInsightsManagement::CreateOrUpdateConnectorMappings;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::CustomerInsightsManagement::ConnectorMappingResourceFormat',
