package Azure::CustomerInsightsManagement::CreateOrUpdateKpi;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::CustomerInsightsManagement::KpiResourceFormat',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::CustomerInsightsManagement::CreateOrUpdateKpiResult');
