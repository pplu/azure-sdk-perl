package Azure::CustomerInsightsManagement::PredictionResourceFormat;
  use Moose;
  ...
  has 'mappings' => (is => 'ro', isa => 'Azure::CustomerInsightsManagement::PredictionResourceFormat_mappings'  );
