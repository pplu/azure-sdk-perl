package Azure::CustomerInsightsManagement::GetConnectorMappings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::CustomerInsightsManagement::GetConnectorMappingsResult');
