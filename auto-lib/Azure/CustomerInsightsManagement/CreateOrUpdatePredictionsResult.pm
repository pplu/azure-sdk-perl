package Azure::CustomerInsightsManagement::CreateOrUpdatePredictionsResult;
  ...
  has mappings => (is => 'ro', isa => 'Azure::CustomerInsightsManagement::CreateOrUpdatePredictionsResult_mappings'  );
  ...
  has systemGeneratedEntities => (is => 'ro', isa => 'Azure::CustomerInsightsManagement::CreateOrUpdatePredictionsResult_systemGeneratedEntities'  );
