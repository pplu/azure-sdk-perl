package Azure::CustomerInsightsManagement::GetModelStatusPredictions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::CustomerInsightsManagement::GetModelStatusPredictionsResult');
