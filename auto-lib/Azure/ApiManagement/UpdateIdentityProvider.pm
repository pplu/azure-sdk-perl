package Azure::ApiManagement::UpdateIdentityProvider;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ApiManagement::IdentityProviderUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::ApiManagement::UpdateIdentityProviderResult',
