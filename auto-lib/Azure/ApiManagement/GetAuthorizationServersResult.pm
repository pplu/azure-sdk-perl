package Azure::ApiManagement::GetAuthorizationServersResult;
  ...
  has authorizationMethods => (is => 'ro', isa => 'ArrayRef[string]'  );
  has bearerTokenSendingMethods => (is => 'ro', isa => 'ArrayRef[string]'  );
  has clientAuthenticationMethod => (is => 'ro', isa => 'ArrayRef[string]'  );
  has clientId => (is => 'ro', isa => 'Str'  );
  has clientRegistrationEndpoint => (is => 'ro', isa => 'Str'  );
  has clientSecret => (is => 'ro', isa => 'Str'  );
  has defaultScope => (is => 'ro', isa => 'Str'  );
  has description => (is => 'ro', isa => 'Str'  );
  has grantTypes => (is => 'ro', isa => 'ArrayRef[string]'  );
