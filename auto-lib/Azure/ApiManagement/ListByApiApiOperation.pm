package Azure::ApiManagement::ListByApiApiOperation;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ApiManagement::ListByApiApiOperationResult',
    
      default => 'Azure::ApiManagement::ListByApiApiOperationResult',
