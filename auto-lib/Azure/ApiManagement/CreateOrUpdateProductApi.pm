package Azure::ApiManagement::CreateOrUpdateProductApi;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ApiManagement::CreateOrUpdateProductApiResult',
    
      201 => 'Azure::ApiManagement::CreateOrUpdateProductApiResult',
    
      default => 'Azure::ApiManagement::CreateOrUpdateProductApiResult',
