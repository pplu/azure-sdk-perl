package Azure::ApiManagement::CreateOrUpdateApiOperation;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ApiManagement::CreateOrUpdateApiOperationResult',
    
      201 => 'Azure::ApiManagement::CreateOrUpdateApiOperationResult',
    
      default => 'Azure::ApiManagement::CreateOrUpdateApiOperationResult',
