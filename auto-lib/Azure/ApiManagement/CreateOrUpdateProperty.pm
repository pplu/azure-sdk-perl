package Azure::ApiManagement::CreateOrUpdateProperty;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ApiManagement::CreateOrUpdatePropertyResult',
    
      201 => 'Azure::ApiManagement::CreateOrUpdatePropertyResult',
    
      default => 'Azure::ApiManagement::CreateOrUpdatePropertyResult',
