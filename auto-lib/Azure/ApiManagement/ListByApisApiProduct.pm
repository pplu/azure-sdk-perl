package Azure::ApiManagement::ListByApisApiProduct;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ApiManagement::ListByApisApiProductResult',
    
      default => 'Azure::ApiManagement::ListByApisApiProductResult',
