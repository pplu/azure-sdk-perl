package Azure::ApiManagement::CreateOrUpdateApi;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ApiManagement::ApiCreateOrUpdateParameter',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ApiManagement::CreateOrUpdateApiResult',
    
      201 => 'Azure::ApiManagement::CreateOrUpdateApiResult',
    
      default => 'Azure::ApiManagement::CreateOrUpdateApiResult',
