package Azure::ApiManagement::CreateOrUpdateSubscription;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ApiManagement::SubscriptionCreateParameters',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ApiManagement::CreateOrUpdateSubscriptionResult');
