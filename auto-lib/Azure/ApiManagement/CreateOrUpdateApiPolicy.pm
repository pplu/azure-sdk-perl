package Azure::ApiManagement::CreateOrUpdateApiPolicy;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ApiManagement::CreateOrUpdateApiPolicyResult',
    
      201 => 'Azure::ApiManagement::CreateOrUpdateApiPolicyResult',
    
      default => 'Azure::ApiManagement::CreateOrUpdateApiPolicyResult',
