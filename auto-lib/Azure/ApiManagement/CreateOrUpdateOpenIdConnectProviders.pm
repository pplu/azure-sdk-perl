package Azure::ApiManagement::CreateOrUpdateOpenIdConnectProviders;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ApiManagement::OpenidConnectProviderCreateContract',
