package Azure::ApiManagement::CreateOrUpdateProductPolicy;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ApiManagement::CreateOrUpdateProductPolicyResult',
    
      201 => 'Azure::ApiManagement::CreateOrUpdateProductPolicyResult',
    
      default => 'Azure::ApiManagement::CreateOrUpdateProductPolicyResult',
