package Azure::Cdn::CreateProfiles;
  use Moose;
  ...
  has 'profile' => (is => 'ro', required => 1, isa => 'Azure::Cdn::Profile',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Cdn::CreateProfilesResult',
    
      201 => 'Azure::Cdn::CreateProfilesResult',
    
      202 => 'Azure::Cdn::CreateProfilesResult',
    
      default => 'Azure::Cdn::CreateProfilesResult',
