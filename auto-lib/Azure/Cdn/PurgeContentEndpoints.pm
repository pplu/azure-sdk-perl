package Azure::Cdn::PurgeContentEndpoints;
  use Moose;
  ...
  has 'contentFilePaths' => (is => 'ro', required => 1, isa => 'Azure::Cdn::PurgeParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::Cdn::PurgeContentEndpointsResult',
