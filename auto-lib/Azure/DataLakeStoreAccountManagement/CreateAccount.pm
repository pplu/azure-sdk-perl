package Azure::DataLakeStoreAccountManagement::CreateAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeStoreAccountManagement::CreateAccountResult',
    
      201 => 'Azure::DataLakeStoreAccountManagement::CreateAccountResult',
