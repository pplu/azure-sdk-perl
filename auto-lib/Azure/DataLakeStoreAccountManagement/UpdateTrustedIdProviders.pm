package Azure::DataLakeStoreAccountManagement::UpdateTrustedIdProviders;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::DataLakeStoreAccountManagement::UpdateTrustedIdProviderParameters',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeStoreAccountManagement::UpdateTrustedIdProvidersResult');
