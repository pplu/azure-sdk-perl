package Azure::DataLakeStoreAccountManagement::GetFirewallRules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeStoreAccountManagement::GetFirewallRulesResult');
