package Azure::DataLakeStoreAccountManagement::GetTrustedIdProviders;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeStoreAccountManagement::GetTrustedIdProvidersResult');
