package Azure::DataLakeStoreAccountManagement::GetFirewallRuleAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeStoreAccountManagement::GetFirewallRuleAccountResult');
