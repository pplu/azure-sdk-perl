package Azure::DataLakeStoreAccountManagement::CreateOrUpdateFirewallRules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeStoreAccountManagement::CreateOrUpdateFirewallRulesResult');
