package Azure::DataLakeStoreAccountManagement::UpdateFirewallRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::DataLakeStoreAccountManagement::UpdateFirewallRuleParameters',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeStoreAccountManagement::UpdateFirewallRulesResult');
