package Azure::ManagedApplication::GetApplianceDefinitions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ManagedApplication::GetApplianceDefinitionsResult',
    
      404 => undef,
    
      default => 'Azure::ManagedApplication::GetApplianceDefinitionsResult',
