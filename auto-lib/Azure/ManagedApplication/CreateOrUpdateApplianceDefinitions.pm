package Azure::ManagedApplication::CreateOrUpdateApplianceDefinitions;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ManagedApplication::CreateOrUpdateApplianceDefinitionsResult',
    
      201 => 'Azure::ManagedApplication::CreateOrUpdateApplianceDefinitionsResult',
    
      default => 'Azure::ManagedApplication::CreateOrUpdateApplianceDefinitionsResult',
