package Azure::CertificateRegistration::GetAppServiceCertificateOrders;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CertificateRegistration::GetAppServiceCertificateOrdersResult',
    
      default => 'Azure::CertificateRegistration::GetAppServiceCertificateOrdersResult',
