package Azure::CertificateRegistration::GetCertificateAppServiceCertificateOrders;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::CertificateRegistration::GetCertificateAppServiceCertificateOrdersResult',
    
      default => 'Azure::CertificateRegistration::GetCertificateAppServiceCertificateOrdersResult',
