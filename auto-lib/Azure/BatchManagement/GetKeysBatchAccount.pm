package Azure::BatchManagement::GetKeysBatchAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchManagement::GetKeysBatchAccountResult',
    
      default => 'Azure::BatchManagement::GetKeysBatchAccountResult',
