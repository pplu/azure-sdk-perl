package Azure::BatchManagement::GetApplicationPackage;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchManagement::GetApplicationPackageResult',
    
      default => 'Azure::BatchManagement::GetApplicationPackageResult',
