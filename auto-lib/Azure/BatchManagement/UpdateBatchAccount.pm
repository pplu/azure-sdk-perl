package Azure::BatchManagement::UpdateBatchAccount;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::BatchManagement::BatchAccountUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::BatchManagement::UpdateBatchAccountResult',
    
      default => 'Azure::BatchManagement::UpdateBatchAccountResult',
