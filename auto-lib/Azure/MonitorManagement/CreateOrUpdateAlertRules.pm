package Azure::MonitorManagement::CreateOrUpdateAlertRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::MonitorManagement::AlertRuleResource',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::MonitorManagement::CreateOrUpdateAlertRulesResult');
