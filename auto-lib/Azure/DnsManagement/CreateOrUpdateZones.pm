package Azure::DnsManagement::CreateOrUpdateZones;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DnsManagement::CreateOrUpdateZonesResult',
    
      201 => 'Azure::DnsManagement::CreateOrUpdateZonesResult',
    
      default => 'Azure::DnsManagement::CreateOrUpdateZonesResult',
