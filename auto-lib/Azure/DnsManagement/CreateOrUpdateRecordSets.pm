package Azure::DnsManagement::CreateOrUpdateRecordSets;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DnsManagement::CreateOrUpdateRecordSetsResult',
    
      201 => 'Azure::DnsManagement::CreateOrUpdateRecordSetsResult',
    
      default => 'Azure::DnsManagement::CreateOrUpdateRecordSetsResult',
