package Azure::DnsManagement::ListAllInResourceGroupRecordSets;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DnsManagement::ListAllInResourceGroupRecordSetsResult');
