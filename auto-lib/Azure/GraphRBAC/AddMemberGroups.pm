package Azure::GraphRBAC::AddMemberGroups;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::GraphRBAC::GroupAddMemberParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::GraphRBAC::AddMemberGroupsResult',
