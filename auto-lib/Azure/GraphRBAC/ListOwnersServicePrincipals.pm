package Azure::GraphRBAC::ListOwnersServicePrincipals;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::GraphRBAC::ListOwnersServicePrincipalsResult',
    
      default => 'Azure::GraphRBAC::ListOwnersServicePrincipalsResult',
