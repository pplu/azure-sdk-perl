package Azure::GraphRBAC::ListPasswordCredentialsApplications;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::GraphRBAC::ListPasswordCredentialsApplicationsResult',
    
      default => 'Azure::GraphRBAC::ListPasswordCredentialsApplicationsResult',
