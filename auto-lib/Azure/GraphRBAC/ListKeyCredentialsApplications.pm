package Azure::GraphRBAC::ListKeyCredentialsApplications;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::GraphRBAC::ListKeyCredentialsApplicationsResult',
    
      default => 'Azure::GraphRBAC::ListKeyCredentialsApplicationsResult',
