package Azure::GraphRBAC::PatchApplications;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::GraphRBAC::ApplicationUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      default => 'Azure::GraphRBAC::PatchApplicationsResult',
