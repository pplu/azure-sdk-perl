package Azure::StorageImportExport::CreateOrUpdateJobs;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::StorageImportExport::CreateOrUpdateJobsResult',
    
      201 => 'Azure::StorageImportExport::CreateOrUpdateJobsResult',
    
      default => 'Azure::StorageImportExport::CreateOrUpdateJobsResult',
