package Azure::StorageImportExport::ListByResourceGroupJobs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::StorageImportExport::ListByResourceGroupJobsResult',
    
      default => 'Azure::StorageImportExport::ListByResourceGroupJobsResult',
