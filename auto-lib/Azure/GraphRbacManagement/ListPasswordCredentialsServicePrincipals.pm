package Azure::GraphRbacManagement::ListPasswordCredentialsServicePrincipals;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::GraphRbacManagement::ListPasswordCredentialsServicePrincipalsResult',
    
      default => 'Azure::GraphRbacManagement::ListPasswordCredentialsServicePrincipalsResult',
