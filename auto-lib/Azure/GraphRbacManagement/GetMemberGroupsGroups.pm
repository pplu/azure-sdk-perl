package Azure::GraphRbacManagement::GetMemberGroupsGroups;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::GraphRbacManagement::GroupGetMemberGroupsParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::GraphRbacManagement::GetMemberGroupsGroupsResult',
    
      default => 'Azure::GraphRbacManagement::GetMemberGroupsGroupsResult',
