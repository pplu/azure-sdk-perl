package Azure::GraphRbacManagement::GetApplications;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::GraphRbacManagement::GetApplicationsResult',
    
      default => 'Azure::GraphRbacManagement::GetApplicationsResult',
