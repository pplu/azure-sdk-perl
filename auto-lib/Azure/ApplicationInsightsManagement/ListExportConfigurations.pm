package Azure::ApplicationInsightsManagement::ListExportConfigurations;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ApplicationInsightsManagement::ListExportConfigurationsResult');
