package Azure::ApplicationInsightsManagement::UpdateTagsWebTests;
  use Moose;
  use MooseX::ClassAttribute;

  has 'WebTestTags' => (is => 'ro', required => 1, isa => 'Azure::ApplicationInsightsManagement::TagsResource',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ApplicationInsightsManagement::UpdateTagsWebTestsResult');
