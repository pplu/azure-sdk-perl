package Azure::ApplicationInsightsManagement::GetComponentCurrentBillingFeatures;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ApplicationInsightsManagement::GetComponentCurrentBillingFeaturesResult');
