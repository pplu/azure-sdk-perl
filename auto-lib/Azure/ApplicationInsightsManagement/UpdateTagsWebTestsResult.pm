package Azure::ApplicationInsightsManagement::UpdateTagsWebTestsResult;
  use Moose;
  ...
  has Configuration => (is => 'ro', isa => 'Azure::ApplicationInsightsManagement::UpdateTagsWebTestsResult_Configuration'  );
