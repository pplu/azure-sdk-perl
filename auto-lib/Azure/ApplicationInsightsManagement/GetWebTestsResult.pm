package Azure::ApplicationInsightsManagement::GetWebTestsResult;
  use Moose;
  ...
  has Configuration => (is => 'ro', isa => 'Azure::ApplicationInsightsManagement::GetWebTestsResult_Configuration'  );
