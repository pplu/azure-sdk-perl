package Azure::ApplicationInsightsManagement::DeleteExportConfigurations;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ApplicationInsightsManagement::DeleteExportConfigurationsResult');
