package Azure::ApplicationInsightsManagement::CreateOrUpdateWebTestsResult;
  use Moose;
  ...
  has Configuration => (is => 'ro', isa => 'Azure::ApplicationInsightsManagement::CreateOrUpdateWebTestsResult_Configuration'  );
