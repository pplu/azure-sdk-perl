package Azure::ApplicationInsightsManagement::GetExportConfigurations;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ApplicationInsightsManagement::GetExportConfigurationsResult');
