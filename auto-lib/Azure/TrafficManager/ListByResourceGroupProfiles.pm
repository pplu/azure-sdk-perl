package Azure::TrafficManager::ListByResourceGroupProfiles;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::TrafficManager::ListByResourceGroupProfilesResult',
    
      default => 'Azure::TrafficManager::ListByResourceGroupProfilesResult',
