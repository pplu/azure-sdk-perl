package Azure::SqlManagement::CreateOrUpdateDatabases;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::SqlManagement::Database',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SqlManagement::CreateOrUpdateDatabasesResult');
