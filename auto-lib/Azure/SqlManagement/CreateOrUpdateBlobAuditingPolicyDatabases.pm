package Azure::SqlManagement::CreateOrUpdateBlobAuditingPolicyDatabases;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SqlManagement::CreateOrUpdateBlobAuditingPolicyDatabasesResult');
