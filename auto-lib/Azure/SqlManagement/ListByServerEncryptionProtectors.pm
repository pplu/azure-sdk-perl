package Azure::SqlManagement::ListByServerEncryptionProtectors;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SqlManagement::ListByServerEncryptionProtectorsResult');
