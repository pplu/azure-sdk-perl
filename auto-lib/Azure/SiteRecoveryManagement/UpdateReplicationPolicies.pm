package Azure::SiteRecoveryManagement::UpdateReplicationPolicies;
  use Moose;
  ...
  has 'input' => (is => 'ro', required => 1, isa => 'Azure::SiteRecoveryManagement::UpdatePolicyInput',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::UpdateReplicationPoliciesResult');
