package Azure::SiteRecoveryManagement::CreateReplicationvCenters;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::CreateReplicationvCentersResult');
