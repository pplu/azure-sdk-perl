package Azure::SiteRecoveryManagement::RepairReplicationReplicationProtectedItems;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::RepairReplicationReplicationProtectedItemsResult');
