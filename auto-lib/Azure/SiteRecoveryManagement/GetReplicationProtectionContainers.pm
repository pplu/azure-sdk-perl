package Azure::SiteRecoveryManagement::GetReplicationProtectionContainers;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::GetReplicationProtectionContainersResult');
