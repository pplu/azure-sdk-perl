package Azure::SiteRecoveryManagement::UpdateReplicationvCenters;
  use Moose;
  ...
  has 'updateVCenterRequest' => (is => 'ro', required => 1, isa => 'Azure::SiteRecoveryManagement::UpdateVCenterRequest',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::UpdateReplicationvCentersResult');
