package Azure::SiteRecoveryManagement::InMageEnableProtectionInput;
  use Moose;

  has 'datastoreName' => (is => 'ro', isa => 'Str'  );
  has 'diskExclusionInput' => (is => 'ro', isa => 'Azure::SiteRecoveryManagement::InMageDiskExclusionInput'  );
