package Azure::SiteRecoveryManagement::ApplyRecoveryPointReplicationProtectedItems;
  use Moose;
  ...
  has 'applyRecoveryPointInput' => (is => 'ro', required => 1, isa => 'Azure::SiteRecoveryManagement::ApplyRecoveryPointInput',
