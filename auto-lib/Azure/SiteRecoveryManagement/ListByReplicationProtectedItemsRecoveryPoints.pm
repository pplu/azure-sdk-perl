package Azure::SiteRecoveryManagement::ListByReplicationProtectedItemsRecoveryPoints;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::ListByReplicationProtectedItemsRecoveryPointsResult');
