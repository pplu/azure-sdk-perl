package Azure::SiteRecoveryManagement::UpdateReplicationNetworkMappings;
  use Moose;
  ...
  has 'input' => (is => 'ro', required => 1, isa => 'Azure::SiteRecoveryManagement::UpdateNetworkMappingInput',
