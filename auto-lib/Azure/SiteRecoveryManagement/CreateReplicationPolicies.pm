package Azure::SiteRecoveryManagement::CreateReplicationPolicies;
  use Moose;
  ...
  has 'input' => (is => 'ro', required => 1, isa => 'Azure::SiteRecoveryManagement::CreatePolicyInput',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::CreateReplicationPoliciesResult');
