package Azure::SiteRecoveryManagement::GetReplicationAlertSettings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::GetReplicationAlertSettingsResult');
