package Azure::SiteRecoveryManagement::FailoverCommitReplicationProtectedItems;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::FailoverCommitReplicationProtectedItemsResult');
