package Azure::SiteRecoveryManagement::UnplannedFailoverReplicationProtectedItems;
  use Moose;
  ...
  has 'failoverInput' => (is => 'ro', required => 1, isa => 'Azure::SiteRecoveryManagement::UnplannedFailoverInput',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::UnplannedFailoverReplicationProtectedItemsResult');
