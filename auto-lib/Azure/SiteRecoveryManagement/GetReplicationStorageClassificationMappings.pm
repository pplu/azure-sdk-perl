package Azure::SiteRecoveryManagement::GetReplicationStorageClassificationMappings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::GetReplicationStorageClassificationMappingsResult');
