package Azure::SiteRecoveryManagement::GetReplicationNetworkMappings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::GetReplicationNetworkMappingsResult');
