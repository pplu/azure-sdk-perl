package Azure::SiteRecoveryManagement::GetReplicationProtectionContainerMappings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::GetReplicationProtectionContainerMappingsResult');
