package Azure::SiteRecoveryManagement::TestFailoverCleanupReplicationProtectedItems;
  use Moose;
  ...
  has 'cleanupInput' => (is => 'ro', required => 1, isa => 'Azure::SiteRecoveryManagement::TestFailoverCleanupInput',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::TestFailoverCleanupReplicationProtectedItemsResult');
