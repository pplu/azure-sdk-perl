package Azure::SiteRecoveryManagement::GetRecoveryPoints;
  use Moose;
  ...
  has 'recoveryPointName' => (is => 'ro', required => 1, isa => 'Str',
    traits => [ 'Azure::ParamInPath' ],
  );
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::GetRecoveryPointsResult');
