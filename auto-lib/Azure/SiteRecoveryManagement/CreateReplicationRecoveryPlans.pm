package Azure::SiteRecoveryManagement::CreateReplicationRecoveryPlans;
  use Moose;
  ...
  has 'input' => (is => 'ro', required => 1, isa => 'Azure::SiteRecoveryManagement::CreateRecoveryPlanInput',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::CreateReplicationRecoveryPlansResult');
