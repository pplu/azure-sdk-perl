package Azure::SiteRecoveryManagement::GetReplicationRecoveryPlans;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::SiteRecoveryManagement::GetReplicationRecoveryPlansResult');
