package Azure::EngagementManagement::CreateImportTasks;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::EngagementManagement::importTask',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      201 => 'Azure::EngagementManagement::CreateImportTasksResult',
    
      202 => 'Azure::EngagementManagement::CreateImportTasksResult',
    
      default => 'Azure::EngagementManagement::CreateImportTasksResult',
