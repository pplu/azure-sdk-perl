package Azure::EngagementManagement::CreateFeedbackTaskByDateRangeExportTasks;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      202 => 'Azure::EngagementManagement::CreateFeedbackTaskByDateRangeExportTasksResult',
    
      default => 'Azure::EngagementManagement::CreateFeedbackTaskByDateRangeExportTasksResult',
