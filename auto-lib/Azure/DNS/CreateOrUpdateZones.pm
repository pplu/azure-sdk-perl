package Azure::DNS::CreateOrUpdateZones;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DNS::Zone',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DNS::CreateOrUpdateZonesResult',
    
      201 => 'Azure::DNS::CreateOrUpdateZonesResult',
    
      default => 'Azure::DNS::CreateOrUpdateZonesResult',
