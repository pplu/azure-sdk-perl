package Azure::ServiceMap::ListByWorkspaceMachineGroups;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceMap::ListByWorkspaceMachineGroupsResult',
    
      default => 'Azure::ServiceMap::ListByWorkspaceMachineGroupsResult',
