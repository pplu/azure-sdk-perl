package Azure::KeyVaultData::decrypt;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/keys/{key-name}/{key-version}/decrypt');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::KeyVaultData::decryptResult',
    
      default => 'Azure::KeyVaultData::decryptResult',
