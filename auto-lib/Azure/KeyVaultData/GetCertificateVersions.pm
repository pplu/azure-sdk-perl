package Azure::KeyVaultData::GetCertificateVersions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::GetCertificateVersionsResult',
    
      default => 'Azure::KeyVaultData::GetCertificateVersionsResult',
