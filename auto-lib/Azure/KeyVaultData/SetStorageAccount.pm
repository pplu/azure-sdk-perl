package Azure::KeyVaultData::SetStorageAccount;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::KeyVaultData::StorageAccountCreateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::SetStorageAccountResult',
    
      default => 'Azure::KeyVaultData::SetStorageAccountResult',
