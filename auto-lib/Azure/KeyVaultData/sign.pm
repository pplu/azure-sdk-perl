package Azure::KeyVaultData::sign;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::KeyVaultData::KeySignParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::signResult',
    
      default => 'Azure::KeyVaultData::signResult',
