package Azure::KeyVaultData::wrapKey;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/keys/{key-name}/{key-version}/wrapkey');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::KeyVaultData::wrapKeyResult',
    
      default => 'Azure::KeyVaultData::wrapKeyResult',
