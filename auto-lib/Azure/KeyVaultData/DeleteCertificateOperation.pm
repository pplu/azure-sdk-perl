package Azure::KeyVaultData::DeleteCertificateOperation;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::DeleteCertificateOperationResult',
    
      default => 'Azure::KeyVaultData::DeleteCertificateOperationResult',
