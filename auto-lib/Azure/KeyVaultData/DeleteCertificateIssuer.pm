package Azure::KeyVaultData::DeleteCertificateIssuer;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::DeleteCertificateIssuerResult',
    
      default => 'Azure::KeyVaultData::DeleteCertificateIssuerResult',
