package Azure::KeyVaultData::GetDeletedCertificate;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::GetDeletedCertificateResult',
    
      default => 'Azure::KeyVaultData::GetDeletedCertificateResult',
