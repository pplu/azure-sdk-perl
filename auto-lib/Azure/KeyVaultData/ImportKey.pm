package Azure::KeyVaultData::ImportKey;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::KeyVaultData::KeyImportParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::ImportKeyResult',
    
      default => 'Azure::KeyVaultData::ImportKeyResult',
