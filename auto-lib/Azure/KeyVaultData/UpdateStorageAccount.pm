package Azure::KeyVaultData::UpdateStorageAccount;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::KeyVaultData::StorageAccountUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::UpdateStorageAccountResult',
    
      default => 'Azure::KeyVaultData::UpdateStorageAccountResult',
