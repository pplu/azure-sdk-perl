package Azure::KeyVaultData::RecoverDeletedCertificate;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::RecoverDeletedCertificateResult',
    
      default => 'Azure::KeyVaultData::RecoverDeletedCertificateResult',
