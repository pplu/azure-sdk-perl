package Azure::KeyVaultData::UpdateCertificatePolicy;
  use Moose;
  ...
  has 'certificatePolicy' => (is => 'ro', required => 1, isa => 'Azure::KeyVaultData::CertificatePolicy',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::KeyVaultData::UpdateCertificatePolicyResult',
    
      default => 'Azure::KeyVaultData::UpdateCertificatePolicyResult',
