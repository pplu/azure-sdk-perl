package Azure::KeyVaultData::GetDeletedSasDefinition;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/deletedstorage/{storage-account-name}/sas/{sas-definition-name}');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::KeyVaultData::GetDeletedSasDefinitionResult',
    
      default => 'Azure::KeyVaultData::GetDeletedSasDefinitionResult',
