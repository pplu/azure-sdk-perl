package Azure::KeyVaultData::unwrapKey;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/keys/{key-name}/{key-version}/unwrapkey');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::KeyVaultData::unwrapKeyResult',
    
      default => 'Azure::KeyVaultData::unwrapKeyResult',
