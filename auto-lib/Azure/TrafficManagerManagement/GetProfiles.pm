package Azure::TrafficManagerManagement::GetProfiles;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::TrafficManagerManagement::GetProfilesResult',
    
      default => 'Azure::TrafficManagerManagement::GetProfilesResult',
