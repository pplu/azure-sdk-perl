package Azure::TrafficManagerManagement::ListByResourceGroupProfiles;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::TrafficManagerManagement::ListByResourceGroupProfilesResult',
    
      default => 'Azure::TrafficManagerManagement::ListByResourceGroupProfilesResult',
