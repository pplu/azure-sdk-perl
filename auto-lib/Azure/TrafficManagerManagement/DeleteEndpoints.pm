package Azure::TrafficManagerManagement::DeleteEndpoints;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::TrafficManagerManagement::DeleteEndpointsResult',
    
      204 => undef,
    
      default => 'Azure::TrafficManagerManagement::DeleteEndpointsResult',
