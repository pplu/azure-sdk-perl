package Azure::CognitiveImageSearch::TrendingImages;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/images/trending');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::CognitiveImageSearch::TrendingImagesResult',
    
      default => 'Azure::CognitiveImageSearch::TrendingImagesResult',
