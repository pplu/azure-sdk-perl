package Azure::HDInsightManagement::CreateApplications;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::HDInsightManagement::ApplicationGetProperties',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::HDInsightManagement::CreateApplicationsResult');
