package Azure::HDInsightManagement::ListPersistedScriptsScriptActions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::HDInsightManagement::ListPersistedScriptsScriptActionsResult');
