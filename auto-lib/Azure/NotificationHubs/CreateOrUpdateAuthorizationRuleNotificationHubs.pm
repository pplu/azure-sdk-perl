package Azure::NotificationHubs::CreateOrUpdateAuthorizationRuleNotificationHubs;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::NotificationHubs::SharedAccessAuthorizationRuleCreateOrUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NotificationHubs::CreateOrUpdateAuthorizationRuleNotificationHubsResult',
