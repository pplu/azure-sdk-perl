package Azure::NotificationHubs::RegenerateKeysNotificationHubs;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::NotificationHubs::PolicykeyResource',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NotificationHubs::RegenerateKeysNotificationHubsResult',
