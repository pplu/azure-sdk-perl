package Azure::NotificationHubs::PatchNotificationHubs;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::NotificationHubs::NotificationHubPatchParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NotificationHubs::PatchNotificationHubsResult',
