package Azure::NotificationHubs::CreateOrUpdateNotificationHubs;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::NotificationHubs::NotificationHubCreateOrUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NotificationHubs::CreateOrUpdateNotificationHubsResult',
    
      201 => 'Azure::NotificationHubs::CreateOrUpdateNotificationHubsResult',
