package Azure::Capacity::GetAppliedReservationList;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::Capacity::GetAppliedReservationListResult',
    
      default => 'Azure::Capacity::GetAppliedReservationListResult',
