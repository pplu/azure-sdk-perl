package Azure::ManagementLock::GetAtResourceGroupLevelManagementLocks;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ManagementLock::GetAtResourceGroupLevelManagementLocksResult');
