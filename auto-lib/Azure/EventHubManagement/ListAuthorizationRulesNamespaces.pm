package Azure::EventHubManagement::ListAuthorizationRulesNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHubManagement::ListAuthorizationRulesNamespacesResult',
    
      default => 'Azure::EventHubManagement::ListAuthorizationRulesNamespacesResult',
