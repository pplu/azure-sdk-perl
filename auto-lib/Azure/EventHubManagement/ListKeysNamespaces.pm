package Azure::EventHubManagement::ListKeysNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHubManagement::ListKeysNamespacesResult',
    
      default => 'Azure::EventHubManagement::ListKeysNamespacesResult',
