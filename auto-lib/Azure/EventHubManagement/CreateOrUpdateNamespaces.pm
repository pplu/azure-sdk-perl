package Azure::EventHubManagement::CreateOrUpdateNamespaces;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHubManagement::CreateOrUpdateNamespacesResult',
    
      201 => 'Azure::EventHubManagement::CreateOrUpdateNamespacesResult',
    
      202 => undef,
    
      default => 'Azure::EventHubManagement::CreateOrUpdateNamespacesResult',
