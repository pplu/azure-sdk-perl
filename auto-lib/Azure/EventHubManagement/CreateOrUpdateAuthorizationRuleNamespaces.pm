package Azure::EventHubManagement::CreateOrUpdateAuthorizationRuleNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHubManagement::CreateOrUpdateAuthorizationRuleNamespacesResult',
    
      default => 'Azure::EventHubManagement::CreateOrUpdateAuthorizationRuleNamespacesResult',
