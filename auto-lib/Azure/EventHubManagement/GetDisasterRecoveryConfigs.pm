package Azure::EventHubManagement::GetDisasterRecoveryConfigs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::EventHubManagement::GetDisasterRecoveryConfigsResult',
    
      default => 'Azure::EventHubManagement::GetDisasterRecoveryConfigsResult',
