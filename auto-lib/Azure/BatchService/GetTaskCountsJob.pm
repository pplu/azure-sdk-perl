package Azure::BatchService::GetTaskCountsJob;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/jobs/{jobId}/taskcounts');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::BatchService::GetTaskCountsJobResult',
    
      default => 'Azure::BatchService::GetTaskCountsJobResult',
