package Azure::BatchService::TerminateJobSchedule;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/jobschedules/{jobScheduleId}/terminate');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      202 => undef,
    
      default => 'Azure::BatchService::TerminateJobScheduleResult',
