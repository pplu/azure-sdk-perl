package Azure::BatchService::UpgradeOSPool;
  use Moose;
  ...
  has 'poolUpgradeOSParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchService::PoolUpgradeOSParameter',
  ...
  class_has _api_uri => (is => 'ro', default => '/pools/{poolId}/upgradeos');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      202 => undef,
    
      default => 'Azure::BatchService::UpgradeOSPoolResult',
