package Azure::BatchService::EnableAutoScalePool;
  use Moose;
  ...
  has 'poolEnableAutoScaleParameter' => (is => 'ro', required => 1, isa => 'Azure::BatchService::PoolEnableAutoScaleParameter',
  ...
  class_has _api_uri => (is => 'ro', default => '/pools/{poolId}/enableautoscale');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => undef,
    
      default => 'Azure::BatchService::EnableAutoScalePoolResult',
