package Azure::ServiceFabricManagement::CreateClusters;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ServiceFabricManagement::Cluster',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ServiceFabricManagement::CreateClustersResult');
