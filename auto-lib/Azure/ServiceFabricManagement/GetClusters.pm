package Azure::ServiceFabricManagement::GetClusters;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceFabricManagement::GetClustersResult',
    
      default => 'Azure::ServiceFabricManagement::GetClustersResult',
