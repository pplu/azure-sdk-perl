package Azure::ServiceFabricManagement::PatchApplication;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ServiceFabricManagement::ApplicationResourceUpdate',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::ServiceFabricManagement::PatchApplicationResult');
