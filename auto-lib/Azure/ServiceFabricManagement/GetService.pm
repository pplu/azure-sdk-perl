package Azure::ServiceFabricManagement::GetService;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceFabricManagement::GetServiceResult',
    
      default => 'Azure::ServiceFabricManagement::GetServiceResult',
