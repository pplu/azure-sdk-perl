package Azure::ServiceFabricManagement::GetApplication;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceFabricManagement::GetApplicationResult',
    
      default => 'Azure::ServiceFabricManagement::GetApplicationResult',
