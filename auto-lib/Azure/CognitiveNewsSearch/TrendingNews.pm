package Azure::CognitiveNewsSearch::TrendingNews;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/news/trendingtopics');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::CognitiveNewsSearch::TrendingNewsResult',
    
      default => 'Azure::CognitiveNewsSearch::TrendingNewsResult',
