package Azure::CognitiveNewsSearch::SearchNews;
  use Moose;
  ...
  class_has _api_uri => (is => 'ro', default => '/news/search');
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
    
      200 => 'Azure::CognitiveNewsSearch::SearchNewsResult',
    
      default => 'Azure::CognitiveNewsSearch::SearchNewsResult',
