package Azure::CognitiveNewsSearch::NewsArticle;
  use Moose;

  has 'category' => (is => 'ro', isa => 'Str'  );
  has 'clusteredArticles' => (is => 'ro', isa => 'ArrayRef[Azure::CognitiveNewsSearch::NewsArticle]'  );
  has 'headline' => (is => 'ro', isa => 'Bool'  );
