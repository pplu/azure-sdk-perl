package Azure::TimeSeriesInsights::GetAccessPolicies;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::TimeSeriesInsights::GetAccessPoliciesResult',
    
      default => 'Azure::TimeSeriesInsights::GetAccessPoliciesResult',
