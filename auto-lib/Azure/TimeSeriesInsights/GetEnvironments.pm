package Azure::TimeSeriesInsights::GetEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::TimeSeriesInsights::GetEnvironmentsResult',
    
      default => 'Azure::TimeSeriesInsights::GetEnvironmentsResult',
