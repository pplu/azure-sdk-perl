package Azure::TimeSeriesInsights::GetEventSources;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::TimeSeriesInsights::GetEventSourcesResult',
    
      default => 'Azure::TimeSeriesInsights::GetEventSourcesResult',
