package Azure::ServiceFabric::CreateClusters;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ServiceFabric::Cluster',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceFabric::CreateClustersResult',
    
      202 => 'Azure::ServiceFabric::CreateClustersResult',
    
      default => 'Azure::ServiceFabric::CreateClustersResult',
