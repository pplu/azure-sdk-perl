package Azure::NetworkResourceProvider::GetExpressRouteCircuits;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::GetExpressRouteCircuitsResult');
