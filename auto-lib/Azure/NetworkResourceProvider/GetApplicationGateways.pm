package Azure::NetworkResourceProvider::GetApplicationGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::GetApplicationGatewaysResult');
