package Azure::NetworkResourceProvider::GetVirtualNetworkGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::GetVirtualNetworkGatewaysResult');
