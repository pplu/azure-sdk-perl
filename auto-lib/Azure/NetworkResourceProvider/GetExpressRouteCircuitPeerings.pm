package Azure::NetworkResourceProvider::GetExpressRouteCircuitPeerings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::GetExpressRouteCircuitPeeringsResult');
