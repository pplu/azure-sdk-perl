package Azure::NetworkResourceProvider::CreateOrUpdateExpressRouteCircuitAuthorizations;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::CreateOrUpdateExpressRouteCircuitAuthorizationsResult');
