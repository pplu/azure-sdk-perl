package Azure::NetworkResourceProvider::CreateOrUpdateRouteTables;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::CreateOrUpdateRouteTablesResult');
