package Azure::NetworkResourceProvider::CreateOrUpdateSecurityRules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::CreateOrUpdateSecurityRulesResult');
