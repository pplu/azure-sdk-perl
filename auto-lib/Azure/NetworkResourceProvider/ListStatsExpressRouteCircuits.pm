package Azure::NetworkResourceProvider::ListStatsExpressRouteCircuits;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::ListStatsExpressRouteCircuitsResult');
