package Azure::NetworkResourceProvider::GetLocalNetworkGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::GetLocalNetworkGatewaysResult');
