package Azure::NetworkResourceProvider::ListArpTableExpressRouteCircuits;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::ListArpTableExpressRouteCircuitsResult');
