package Azure::NetworkResourceProvider::CreateOrUpdateLoadBalancers;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::CreateOrUpdateLoadBalancersResult');
