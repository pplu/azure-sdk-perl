package Azure::NetworkResourceProvider::ResetSharedKeyVirtualNetworkGatewayConnections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::ResetSharedKeyVirtualNetworkGatewayConnectionsResult');
