package Azure::NetworkResourceProvider::GetNetworkSecurityGroups;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::GetNetworkSecurityGroupsResult');
