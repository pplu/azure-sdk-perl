package Azure::NetworkResourceProvider::CreateOrUpdateVirtualNetworkGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkResourceProvider::CreateOrUpdateVirtualNetworkGatewaysResult');
