package Azure::DocumentDB::CreateOrUpdateDatabaseAccounts;
  ...
  has 'createUpdateParameters' => (is => 'ro', required => 1, isa => 'Azure::DocumentDB::DatabaseAccountCreateUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DocumentDB::CreateOrUpdateDatabaseAccountsResult',
