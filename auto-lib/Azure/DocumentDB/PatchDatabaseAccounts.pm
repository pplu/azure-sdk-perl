package Azure::DocumentDB::PatchDatabaseAccounts;
  use Moose;
  ...
  has 'updateParameters' => (is => 'ro', required => 1, isa => 'Azure::DocumentDB::DatabaseAccountPatchParameters',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DocumentDB::PatchDatabaseAccountsResult');
