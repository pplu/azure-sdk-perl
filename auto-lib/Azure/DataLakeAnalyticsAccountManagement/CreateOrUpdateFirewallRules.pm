package Azure::DataLakeAnalyticsAccountManagement::CreateOrUpdateFirewallRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DataLakeAnalyticsAccountManagement::FirewallRule',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeAnalyticsAccountManagement::CreateOrUpdateFirewallRulesResult');
