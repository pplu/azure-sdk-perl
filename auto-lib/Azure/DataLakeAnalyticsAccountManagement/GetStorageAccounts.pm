package Azure::DataLakeAnalyticsAccountManagement::GetStorageAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeAnalyticsAccountManagement::GetStorageAccountsResult');
