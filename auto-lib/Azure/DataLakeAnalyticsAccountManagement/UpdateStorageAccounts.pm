package Azure::DataLakeAnalyticsAccountManagement::UpdateStorageAccounts;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::DataLakeAnalyticsAccountManagement::UpdateStorageAccountParameters',
