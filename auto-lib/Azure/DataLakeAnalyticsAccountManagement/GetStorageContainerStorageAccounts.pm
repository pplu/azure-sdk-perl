package Azure::DataLakeAnalyticsAccountManagement::GetStorageContainerStorageAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeAnalyticsAccountManagement::GetStorageContainerStorageAccountsResult');
