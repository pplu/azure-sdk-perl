package Azure::DataLakeAnalyticsAccountManagement::UpdateComputePolicies;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeAnalyticsAccountManagement::UpdateComputePoliciesResult');
