package Azure::DataLakeAnalyticsAccountManagement::ListStorageContainersStorageAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeAnalyticsAccountManagement::ListStorageContainersStorageAccountsResult');
