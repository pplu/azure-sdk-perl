package Azure::DataLakeAnalyticsAccountManagement::CreateOrUpdateComputePolicy;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeAnalyticsAccountManagement::CreateOrUpdateComputePolicyResult');
