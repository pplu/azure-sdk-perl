package Azure::DataLakeAnalyticsAccountManagement::ListStorageAccountsAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeAnalyticsAccountManagement::ListStorageAccountsAccountResult');
