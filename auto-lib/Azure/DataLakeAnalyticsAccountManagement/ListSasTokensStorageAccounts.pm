package Azure::DataLakeAnalyticsAccountManagement::ListSasTokensStorageAccounts;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DataLakeAnalyticsAccountManagement::ListSasTokensStorageAccountsResult');
