package Azure::DataLakeAnalyticsAccountManagement::ListByResourceGroupAccount;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeAnalyticsAccountManagement::ListByResourceGroupAccountResult',
