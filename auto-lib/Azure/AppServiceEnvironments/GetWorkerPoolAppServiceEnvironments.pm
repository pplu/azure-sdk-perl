package Azure::AppServiceEnvironments::GetWorkerPoolAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AppServiceEnvironments::GetWorkerPoolAppServiceEnvironmentsResult');
