package Azure::AppServiceEnvironments::ListWebAppsAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AppServiceEnvironments::ListWebAppsAppServiceEnvironmentsResult');
