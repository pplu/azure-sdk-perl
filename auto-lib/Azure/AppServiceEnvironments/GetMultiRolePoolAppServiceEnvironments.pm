package Azure::AppServiceEnvironments::GetMultiRolePoolAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AppServiceEnvironments::GetMultiRolePoolAppServiceEnvironmentsResult');
