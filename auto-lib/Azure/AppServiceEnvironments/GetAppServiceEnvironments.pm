package Azure::AppServiceEnvironments::GetAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AppServiceEnvironments::GetAppServiceEnvironmentsResult');
