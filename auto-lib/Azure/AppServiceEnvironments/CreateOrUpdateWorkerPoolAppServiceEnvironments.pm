package Azure::AppServiceEnvironments::CreateOrUpdateWorkerPoolAppServiceEnvironments;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::AppServiceEnvironments::CreateOrUpdateWorkerPoolAppServiceEnvironmentsResult',
    
      202 => 'Azure::AppServiceEnvironments::CreateOrUpdateWorkerPoolAppServiceEnvironmentsResult',
