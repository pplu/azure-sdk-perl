package Azure::AppServiceEnvironments::ListWorkerPoolInstanceMetricDefinitionsAppServiceEnvironments;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::AppServiceEnvironments::ListWorkerPoolInstanceMetricDefinitionsAppServiceEnvironmentsResult');
