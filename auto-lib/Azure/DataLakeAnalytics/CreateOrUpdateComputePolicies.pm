package Azure::DataLakeAnalytics::CreateOrUpdateComputePolicies;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DataLakeAnalytics::CreateOrUpdateComputePolicyParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeAnalytics::CreateOrUpdateComputePoliciesResult',
