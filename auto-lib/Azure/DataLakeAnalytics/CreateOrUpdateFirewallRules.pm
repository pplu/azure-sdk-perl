package Azure::DataLakeAnalytics::CreateOrUpdateFirewallRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DataLakeAnalytics::CreateOrUpdateFirewallRuleParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeAnalytics::CreateOrUpdateFirewallRulesResult',
