package Azure::DataLakeAnalytics::UpdateComputePolicies;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::DataLakeAnalytics::UpdateComputePolicyParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeAnalytics::UpdateComputePoliciesResult',
