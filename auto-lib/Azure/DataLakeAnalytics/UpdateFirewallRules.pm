package Azure::DataLakeAnalytics::UpdateFirewallRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', isa => 'Azure::DataLakeAnalytics::UpdateFirewallRuleParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeAnalytics::UpdateFirewallRulesResult',
