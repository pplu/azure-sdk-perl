package Azure::DataLakeAnalytics::CreateAccounts;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DataLakeAnalytics::CreateDataLakeAnalyticsAccountParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DataLakeAnalytics::CreateAccountsResult',
    
      201 => 'Azure::DataLakeAnalytics::CreateAccountsResult',
