package Azure::MachineLearningCompute::GetOperationalizationClusters;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::MachineLearningCompute::GetOperationalizationClustersResult',
    
      default => 'Azure::MachineLearningCompute::GetOperationalizationClustersResult',
