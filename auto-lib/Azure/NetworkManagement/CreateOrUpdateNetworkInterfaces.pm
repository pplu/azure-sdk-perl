package Azure::NetworkManagement::CreateOrUpdateNetworkInterfaces;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::NetworkManagement::NetworkInterface',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NetworkManagement::CreateOrUpdateNetworkInterfacesResult',
    
      201 => 'Azure::NetworkManagement::CreateOrUpdateNetworkInterfacesResult',
