package Azure::NetworkManagement::ResetSharedKeyVirtualNetworkGatewayConnections;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::NetworkManagement::ConnectionResetSharedKey',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkManagement::ResetSharedKeyVirtualNetworkGatewayConnectionsResult');
