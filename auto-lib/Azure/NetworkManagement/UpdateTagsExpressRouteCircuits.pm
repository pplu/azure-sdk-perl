package Azure::NetworkManagement::UpdateTagsExpressRouteCircuits;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkManagement::UpdateTagsExpressRouteCircuitsResult');
