package Azure::NetworkManagement::GetTopologyNetworkWatchers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::NetworkManagement::TopologyParameters',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkManagement::GetTopologyNetworkWatchersResult');
