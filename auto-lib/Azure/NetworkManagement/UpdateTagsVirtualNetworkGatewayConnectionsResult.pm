package Azure::NetworkManagement::UpdateTagsVirtualNetworkGatewayConnectionsResult;
  use Moose;
  ...
  has localNetworkGateway2 => (is => 'ro', isa => 'Azure::NetworkManagement::virtualNetworkConnectionGatewayReference'  );
  ...
  has virtualNetworkGateway1 => (is => 'ro', isa => 'Azure::NetworkManagement::virtualNetworkConnectionGatewayReference'  );
  has virtualNetworkGateway2 => (is => 'ro', isa => 'Azure::NetworkManagement::virtualNetworkConnectionGatewayReference'  );
