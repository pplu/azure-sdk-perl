package Azure::NetworkManagement::CreateOrUpdateExpressRouteCircuitAuthorizations;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NetworkManagement::CreateOrUpdateExpressRouteCircuitAuthorizationsResult',
    
      201 => 'Azure::NetworkManagement::CreateOrUpdateExpressRouteCircuitAuthorizationsResult',
