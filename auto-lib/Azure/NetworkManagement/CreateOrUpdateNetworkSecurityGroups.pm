package Azure::NetworkManagement::CreateOrUpdateNetworkSecurityGroups;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NetworkManagement::CreateOrUpdateNetworkSecurityGroupsResult',
    
      201 => 'Azure::NetworkManagement::CreateOrUpdateNetworkSecurityGroupsResult',
