package Azure::NetworkManagement::UpdateTagsNetworkSecurityGroups;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkManagement::UpdateTagsNetworkSecurityGroupsResult');
