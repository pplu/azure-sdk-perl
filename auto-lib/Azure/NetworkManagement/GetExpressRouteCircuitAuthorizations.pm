package Azure::NetworkManagement::GetExpressRouteCircuitAuthorizations;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkManagement::GetExpressRouteCircuitAuthorizationsResult');
