package Azure::NetworkManagement::ListStatsExpressRouteCircuits;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkManagement::ListStatsExpressRouteCircuitsResult');
