package Azure::NetworkManagement::CreateOrUpdateNetworkWatchers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::NetworkManagement::NetworkWatcher',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NetworkManagement::CreateOrUpdateNetworkWatchersResult',
    
      201 => 'Azure::NetworkManagement::CreateOrUpdateNetworkWatchersResult',
