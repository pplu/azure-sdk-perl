package Azure::NetworkManagement::UpdateTagsVirtualNetworkGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkManagement::UpdateTagsVirtualNetworkGatewaysResult');
