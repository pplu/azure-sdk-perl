package Azure::NetworkManagement::CreateOrUpdateExpressRouteCircuitPeerings;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::NetworkManagement::CreateOrUpdateExpressRouteCircuitPeeringsResult',
    
      201 => 'Azure::NetworkManagement::CreateOrUpdateExpressRouteCircuitPeeringsResult',
