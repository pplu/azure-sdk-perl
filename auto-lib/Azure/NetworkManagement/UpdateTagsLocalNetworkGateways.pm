package Azure::NetworkManagement::UpdateTagsLocalNetworkGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NetworkManagement::UpdateTagsLocalNetworkGatewaysResult');
