package Azure::NetworkManagement::SetSharedKeyVirtualNetworkGatewayConnections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::SetSharedKeyVirtualNetworkGatewayConnectionsResult');
