package Azure::DevTestLabs::CreateOrUpdateSchedules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::CreateOrUpdateSchedulesResult',
    
      201 => 'Azure::DevTestLabs::CreateOrUpdateSchedulesResult',
    
      default => 'Azure::DevTestLabs::CreateOrUpdateSchedulesResult',
