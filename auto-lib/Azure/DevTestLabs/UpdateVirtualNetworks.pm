package Azure::DevTestLabs::UpdateVirtualNetworks;
  use Moose;
  ...
  has 'virtualNetwork' => (is => 'ro', required => 1, isa => 'Azure::DevTestLabs::VirtualNetworkFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::UpdateVirtualNetworksResult',
    
      default => 'Azure::DevTestLabs::UpdateVirtualNetworksResult',
