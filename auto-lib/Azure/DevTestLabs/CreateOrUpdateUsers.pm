package Azure::DevTestLabs::CreateOrUpdateUsers;
  use Moose;
  ...
  has 'user' => (is => 'ro', required => 1, isa => 'Azure::DevTestLabs::User',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::CreateOrUpdateUsersResult',
    
      201 => 'Azure::DevTestLabs::CreateOrUpdateUsersResult',
    
      default => 'Azure::DevTestLabs::CreateOrUpdateUsersResult',
