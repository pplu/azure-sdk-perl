package Azure::DevTestLabs::CreateOrUpdateVirtualNetworks;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::CreateOrUpdateVirtualNetworksResult',
    
      201 => 'Azure::DevTestLabs::CreateOrUpdateVirtualNetworksResult',
    
      default => 'Azure::DevTestLabs::CreateOrUpdateVirtualNetworksResult',
