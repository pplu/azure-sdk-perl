package Azure::DevTestLabs::GetNotificationChannels;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::GetNotificationChannelsResult',
    
      default => 'Azure::DevTestLabs::GetNotificationChannelsResult',
