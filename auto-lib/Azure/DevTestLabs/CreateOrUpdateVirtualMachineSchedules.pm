package Azure::DevTestLabs::CreateOrUpdateVirtualMachineSchedules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::CreateOrUpdateVirtualMachineSchedulesResult',
    
      201 => 'Azure::DevTestLabs::CreateOrUpdateVirtualMachineSchedulesResult',
    
      default => 'Azure::DevTestLabs::CreateOrUpdateVirtualMachineSchedulesResult',
