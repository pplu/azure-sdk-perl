package Azure::DevTestLabs::CreateOrUpdateSecrets;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::CreateOrUpdateSecretsResult',
    
      201 => 'Azure::DevTestLabs::CreateOrUpdateSecretsResult',
    
      default => 'Azure::DevTestLabs::CreateOrUpdateSecretsResult',
