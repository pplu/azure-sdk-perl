package Azure::DevTestLabs::UpdateVirtualMachines;
  use Moose;
  ...
  has 'labVirtualMachine' => (is => 'ro', required => 1, isa => 'Azure::DevTestLabs::LabVirtualMachineFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::UpdateVirtualMachinesResult',
    
      default => 'Azure::DevTestLabs::UpdateVirtualMachinesResult',
