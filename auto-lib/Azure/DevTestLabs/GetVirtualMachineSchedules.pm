package Azure::DevTestLabs::GetVirtualMachineSchedules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::GetVirtualMachineSchedulesResult',
    
      default => 'Azure::DevTestLabs::GetVirtualMachineSchedulesResult',
