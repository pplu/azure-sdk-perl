package Azure::DevTestLabs::CreateOrUpdateFormulas;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::CreateOrUpdateFormulasResult',
    
      201 => 'Azure::DevTestLabs::CreateOrUpdateFormulasResult',
    
      default => 'Azure::DevTestLabs::CreateOrUpdateFormulasResult',
