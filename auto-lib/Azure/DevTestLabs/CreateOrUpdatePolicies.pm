package Azure::DevTestLabs::CreateOrUpdatePolicies;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::CreateOrUpdatePoliciesResult',
    
      201 => 'Azure::DevTestLabs::CreateOrUpdatePoliciesResult',
    
      default => 'Azure::DevTestLabs::CreateOrUpdatePoliciesResult',
