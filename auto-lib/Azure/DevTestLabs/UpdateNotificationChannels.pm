package Azure::DevTestLabs::UpdateNotificationChannels;
  use Moose;
  ...
  has 'notificationChannel' => (is => 'ro', required => 1, isa => 'Azure::DevTestLabs::NotificationChannelFragment',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::UpdateNotificationChannelsResult',
    
      default => 'Azure::DevTestLabs::UpdateNotificationChannelsResult',
