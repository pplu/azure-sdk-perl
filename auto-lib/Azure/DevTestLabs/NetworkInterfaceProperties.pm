package Azure::DevTestLabs::NetworkInterfaceProperties;
  use Moose;
  ...
  has 'sharedPublicIpAddressConfiguration' => (is => 'ro', isa => 'Azure::DevTestLabs::SharedPublicIpAddressConfiguration'  );
