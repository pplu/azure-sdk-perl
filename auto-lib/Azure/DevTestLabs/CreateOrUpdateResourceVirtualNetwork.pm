package Azure::DevTestLabs::CreateOrUpdateResourceVirtualNetwork;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DevTestLabs::CreateOrUpdateResourceVirtualNetworkResult');
