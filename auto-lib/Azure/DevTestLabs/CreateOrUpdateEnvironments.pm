package Azure::DevTestLabs::CreateOrUpdateEnvironments;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DevTestLabs::CreateOrUpdateEnvironmentsResult',
    
      201 => 'Azure::DevTestLabs::CreateOrUpdateEnvironmentsResult',
    
      default => 'Azure::DevTestLabs::CreateOrUpdateEnvironmentsResult',
