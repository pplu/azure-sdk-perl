package Azure::DevTestLabs::CreateOrUpdateEnvironments;
  use Moose;
  ...
  has 'dtlEnvironment' => (is => 'ro', required => 1, isa => 'Azure::DevTestLabs::DtlEnvironment',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::DevTestLabs::CreateOrUpdateEnvironmentsResult');
