package Azure::NotificationHubsManagement::GetAuthorizationRuleNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NotificationHubsManagement::GetAuthorizationRuleNamespacesResult');
