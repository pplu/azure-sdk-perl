package Azure::NotificationHubsManagement::RegenerateKeysNotificationHubs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NotificationHubsManagement::RegenerateKeysNotificationHubsResult');
