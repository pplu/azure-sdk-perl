package Azure::NotificationHubsManagement::ListAuthorizationRulesNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::NotificationHubsManagement::ListAuthorizationRulesNamespacesResult');
