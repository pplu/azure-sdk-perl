package Azure::ImportExport::CreateJobs;
  use Moose;
  ...
  has 'body' => (is => 'ro', required => 1, isa => 'Azure::ImportExport::PutJobParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ImportExport::CreateJobsResult',
    
      201 => 'Azure::ImportExport::CreateJobsResult',
    
      default => 'Azure::ImportExport::CreateJobsResult',
