package Azure::ImportExport::UpdateJobs;
  use Moose;
  ...
  has 'body' => (is => 'ro', required => 1, isa => 'Azure::ImportExport::UpdateJobParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ImportExport::UpdateJobsResult',
    
      default => 'Azure::ImportExport::UpdateJobsResult',
