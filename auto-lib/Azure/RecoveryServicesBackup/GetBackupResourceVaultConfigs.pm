package Azure::RecoveryServicesBackup::GetBackupResourceVaultConfigs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::RecoveryServicesBackup::GetBackupResourceVaultConfigsResult');
