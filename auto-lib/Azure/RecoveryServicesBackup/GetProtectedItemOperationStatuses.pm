package Azure::RecoveryServicesBackup::GetProtectedItemOperationStatuses;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'RecoveryServicesBackup::GetProtectedItemOperationStatusesResult');
