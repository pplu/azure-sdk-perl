package Azure::RecoveryServicesBackup::ListBackupProtectedItems;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::RecoveryServicesBackup::ListBackupProtectedItemsResult');
