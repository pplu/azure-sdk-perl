package Azure::StorSimple8000SeriesManagement::UpdateManagers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimple8000SeriesManagement::ManagerPatch',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimple8000SeriesManagement::UpdateManagersResult');
