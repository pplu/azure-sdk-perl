package Azure::StorSimple8000SeriesManagement::GetBackupSchedules;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimple8000SeriesManagement::GetBackupSchedulesResult');
