package Azure::StorSimple8000SeriesManagement::GetStorageAccountCredentials;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimple8000SeriesManagement::GetStorageAccountCredentialsResult');
