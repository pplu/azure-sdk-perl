package Azure::StorSimple8000SeriesManagement::CreateOrUpdateVolumes;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimple8000SeriesManagement::Volume',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimple8000SeriesManagement::CreateOrUpdateVolumesResult');
