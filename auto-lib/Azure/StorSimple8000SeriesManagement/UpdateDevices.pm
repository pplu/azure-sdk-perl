package Azure::StorSimple8000SeriesManagement::UpdateDevices;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimple8000SeriesManagement::DevicePatch',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimple8000SeriesManagement::UpdateDevicesResult');
