package Azure::StorSimple8000SeriesManagement::GetExtendedInfoManagers;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimple8000SeriesManagement::GetExtendedInfoManagersResult');
