package Azure::StorSimple8000SeriesManagement::CreateOrUpdateStorageAccountCredentials;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimple8000SeriesManagement::StorageAccountCredential',
  ...
  class_has _returns => (is => 'ro', default => 'Azure::StorSimple8000SeriesManagement::CreateOrUpdateStorageAccountCredentialsResult');
