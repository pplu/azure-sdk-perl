package Azure::DBforPostgreSQL::CreateServers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DBforPostgreSQL::ServerForCreate',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DBforPostgreSQL::CreateServersResult',
    
      201 => 'Azure::DBforPostgreSQL::CreateServersResult',
