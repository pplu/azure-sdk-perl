package Azure::DBforPostgreSQL::CreateOrUpdateConfigurations;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DBforPostgreSQL::Configuration',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DBforPostgreSQL::CreateOrUpdateConfigurationsResult',
