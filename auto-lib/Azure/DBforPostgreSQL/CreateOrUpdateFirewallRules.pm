package Azure::DBforPostgreSQL::CreateOrUpdateFirewallRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DBforPostgreSQL::FirewallRule',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DBforPostgreSQL::CreateOrUpdateFirewallRulesResult',
    
      201 => 'Azure::DBforPostgreSQL::CreateOrUpdateFirewallRulesResult',
