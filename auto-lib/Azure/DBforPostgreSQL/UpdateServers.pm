package Azure::DBforPostgreSQL::UpdateServers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::DBforPostgreSQL::ServerUpdateParameters',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::DBforPostgreSQL::UpdateServersResult',
