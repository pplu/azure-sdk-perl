package Azure::CognitiveWebSearch::Images;
  use Moose;
  ...
  has 'similarTerms' => (is => 'ro', isa => 'ArrayRef[Azure::CognitiveWebSearch::Query]'  );
  has 'value' => (is => 'ro', isa => 'ArrayRef[Azure::CognitiveWebSearch::ImageObject]'  );
