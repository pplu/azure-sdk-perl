package Azure::StorSimple::CreateOrUpdateAccessControlRecords;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimple::AccessControlRecord',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::StorSimple::CreateOrUpdateAccessControlRecordsResult',
