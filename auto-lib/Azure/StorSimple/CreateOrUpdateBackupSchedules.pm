package Azure::StorSimple::CreateOrUpdateBackupSchedules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimple::BackupSchedule',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::StorSimple::CreateOrUpdateBackupSchedulesResult',
