package Azure::StorSimple::CreateOrUpdateTimeSettingsDeviceSettings;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimple::TimeSettings',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::StorSimple::CreateOrUpdateTimeSettingsDeviceSettingsResult',
