package Azure::StorSimple::CreateExtendedInfoManagers;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::StorSimple::ManagerExtendedInfo',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::StorSimple::CreateExtendedInfoManagersResult',
