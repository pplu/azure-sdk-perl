package Azure::ServiceBus::ListByResourceGroupNamespaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::ListByResourceGroupNamespacesResult',
    
      default => 'Azure::ServiceBus::ListByResourceGroupNamespacesResult',
