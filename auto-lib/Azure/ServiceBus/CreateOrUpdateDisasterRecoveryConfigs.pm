package Azure::ServiceBus::CreateOrUpdateDisasterRecoveryConfigs;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ServiceBus::ArmDisasterRecovery',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::CreateOrUpdateDisasterRecoveryConfigsResult',
    
      201 => undef,
    
      default => 'Azure::ServiceBus::CreateOrUpdateDisasterRecoveryConfigsResult',
