package Azure::ServiceBus::GetAuthorizationRuleQueues;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::GetAuthorizationRuleQueuesResult',
    
      default => 'Azure::ServiceBus::GetAuthorizationRuleQueuesResult',
