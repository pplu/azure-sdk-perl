package Azure::ServiceBus::GetAuthorizationRuleTopics;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::GetAuthorizationRuleTopicsResult',
    
      default => 'Azure::ServiceBus::GetAuthorizationRuleTopicsResult',
