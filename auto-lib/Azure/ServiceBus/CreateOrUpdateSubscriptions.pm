package Azure::ServiceBus::CreateOrUpdateSubscriptions;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ServiceBus::SBSubscription',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::CreateOrUpdateSubscriptionsResult',
    
      default => 'Azure::ServiceBus::CreateOrUpdateSubscriptionsResult',
