package Azure::ServiceBus::ListByTopicSubscriptions;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::ListByTopicSubscriptionsResult',
    
      default => 'Azure::ServiceBus::ListByTopicSubscriptionsResult',
