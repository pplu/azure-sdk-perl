package Azure::ServiceBus::CreateOrUpdateAuthorizationRuleQueues;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::CreateOrUpdateAuthorizationRuleQueuesResult',
    
      default => 'Azure::ServiceBus::CreateOrUpdateAuthorizationRuleQueuesResult',
