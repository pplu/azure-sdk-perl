package Azure::ServiceBus::CreateOrUpdateRules;
  use Moose;
  ...
  has 'parameters' => (is => 'ro', required => 1, isa => 'Azure::ServiceBus::Rule',
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::CreateOrUpdateRulesResult',
    
      default => 'Azure::ServiceBus::CreateOrUpdateRulesResult',
