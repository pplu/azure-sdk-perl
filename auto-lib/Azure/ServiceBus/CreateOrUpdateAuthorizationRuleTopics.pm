package Azure::ServiceBus::CreateOrUpdateAuthorizationRuleTopics;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::CreateOrUpdateAuthorizationRuleTopicsResult',
    
      default => 'Azure::ServiceBus::CreateOrUpdateAuthorizationRuleTopicsResult',
