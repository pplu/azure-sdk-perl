package Azure::ServiceBus::GetDisasterRecoveryConfigs;
  use Moose;
  ...
  class_has _returns => (is => 'ro', isa => 'HashRef', default => sub { {
      ...
      200 => 'Azure::ServiceBus::GetDisasterRecoveryConfigsResult',
    
      default => 'Azure::ServiceBus::GetDisasterRecoveryConfigsResult',
