package DataLakeAnalyticsCatalogManagement::ListProceduresCatalog;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'DataLakeAnalyticsCatalogManagement::ListProceduresCatalogResult');
