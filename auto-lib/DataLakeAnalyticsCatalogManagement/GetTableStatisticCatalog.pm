package DataLakeAnalyticsCatalogManagement::GetTableStatisticCatalog;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'DataLakeAnalyticsCatalogManagement::GetTableStatisticCatalogResult');
