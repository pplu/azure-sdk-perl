package DataLakeAnalyticsCatalogManagement::GetAssemblyCatalog;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'DataLakeAnalyticsCatalogManagement::GetAssemblyCatalogResult');
