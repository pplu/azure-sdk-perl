package DataLakeAnalyticsCatalogManagement::GetExternalDataSourceCatalog;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'DataLakeAnalyticsCatalogManagement::GetExternalDataSourceCatalogResult');
