package NetworkManagement::GetSharedKeyVirtualNetworkGatewayConnections;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::GetSharedKeyVirtualNetworkGatewayConnectionsResult');
