package NetworkManagement::CheckIPAddressAvailabilityVirtualNetworks;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::CheckIPAddressAvailabilityVirtualNetworksResult');
