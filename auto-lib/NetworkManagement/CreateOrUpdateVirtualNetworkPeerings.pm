package NetworkManagement::CreateOrUpdateVirtualNetworkPeerings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::CreateOrUpdateVirtualNetworkPeeringsResult');
