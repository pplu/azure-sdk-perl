package NetworkManagement::CreateOrUpdateLocalNetworkGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::CreateOrUpdateLocalNetworkGatewaysResult');
