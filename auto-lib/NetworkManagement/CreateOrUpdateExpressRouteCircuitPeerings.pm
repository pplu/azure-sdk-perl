package NetworkManagement::CreateOrUpdateExpressRouteCircuitPeerings;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::CreateOrUpdateExpressRouteCircuitPeeringsResult');
