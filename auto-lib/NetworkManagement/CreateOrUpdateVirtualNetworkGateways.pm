package NetworkManagement::CreateOrUpdateVirtualNetworkGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::CreateOrUpdateVirtualNetworkGatewaysResult');
