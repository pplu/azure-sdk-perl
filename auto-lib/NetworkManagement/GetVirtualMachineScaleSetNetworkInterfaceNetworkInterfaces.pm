package NetworkManagement::GetVirtualMachineScaleSetNetworkInterfaceNetworkInterfaces;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::GetVirtualMachineScaleSetNetworkInterfaceNetworkInterfacesResult');
