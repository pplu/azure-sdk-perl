package NetworkManagement::CreateOrUpdateExpressRouteCircuits;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::CreateOrUpdateExpressRouteCircuitsResult');
