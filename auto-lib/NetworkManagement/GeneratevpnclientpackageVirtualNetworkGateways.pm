package NetworkManagement::GeneratevpnclientpackageVirtualNetworkGateways;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::GeneratevpnclientpackageVirtualNetworkGatewaysResult');
