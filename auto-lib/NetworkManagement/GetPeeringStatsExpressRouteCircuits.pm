package NetworkManagement::GetPeeringStatsExpressRouteCircuits;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkManagement::GetPeeringStatsExpressRouteCircuitsResult');
