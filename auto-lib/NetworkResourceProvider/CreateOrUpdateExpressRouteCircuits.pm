package NetworkResourceProvider::CreateOrUpdateExpressRouteCircuits;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'NetworkResourceProvider::CreateOrUpdateExpressRouteCircuitsResult');
