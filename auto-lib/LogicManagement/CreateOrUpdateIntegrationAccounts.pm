package LogicManagement::CreateOrUpdateIntegrationAccounts;
  use Moose;
  ...
  has 'integrationAccount' => (is => 'ro', required => 1, isa => 'Any',
    traits => [ 'ParamInBody' ],
  );
  ...
  class_has _returns => (is => 'ro', default => 'LogicManagement::CreateOrUpdateIntegrationAccountsResult');
