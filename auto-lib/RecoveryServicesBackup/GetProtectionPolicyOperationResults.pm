package RecoveryServicesBackup::GetProtectionPolicyOperationResults;
  use Moose;
  ...
  class_has _returns => (is => 'ro', default => 'RecoveryServicesBackup::GetProtectionPolicyOperationResultsResult');
